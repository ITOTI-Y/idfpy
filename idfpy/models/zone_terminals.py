...
if TYPE_CHECKING:
    ...
    from .coils import CoilCoolingWater, CoilCoolingWaterDetailedGeometry, CoilHeatingElectric, CoilHeatingFuel, CoilHeatingSteam, CoilHeatingWater
    from .hvac_design import DesignSpecificationAirTerminalSizing, DesignSpecificationOutdoorAir, DesignSpecificationOutdoorAirSpaceList
...
ventilation."""
    ...
    @property
    def beam_cooling_capacity_temperature_difference_modification_factor_curve(self) -> IDFBaseModel | None:
    ...
    @property
    def beam_cooling_capacity_air_flow_modification_factor_curve(self) -> IDFBaseModel | None:
    ...
    @property
    def beam_cooling_capacity_chilled_water_flow_modification_factor_curve(self) -> IDFBaseModel | None:
    ...
    @property
    def beam_heating_capacity_temperature_difference_modification_factor_curve(self) -> IDFBaseModel | None:
    ...
    @property
    def beam_heating_capacity_air_flow_modification_factor_curve(self) -> IDFBaseModel | None:
    ...
    @property
    def beam_heating_capacity_hot_water_flow_modification_factor_curve(self) -> IDFBaseModel | None:
...
ZoneHVAC:EquipmentList."""
    ...
    @property
    def design_specification_air_terminal_sizing_object(self) -> DesignSpecificationAirTerminalSizing | None:
