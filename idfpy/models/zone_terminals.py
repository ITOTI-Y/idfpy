...
class AirTerminalDualDuctVAV(IDFBaseModel):
    ...
    hot_air_inlet_node_name: str = Field(...)
    cold_air_inlet_node_name: str = Field(...)
    maximum_damper_air_flow_rate: float | Literal['Autosize'] = Field(
        ..., json_schema_extra={'units': 'm3/s'}
    )
    ...
    minimum_air_flow_turndown_schedule_name: ScheduleNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['ScheduleNames'],
            'note': 'This field adjusts the design minimum flow rate by multiplying it using this schedule of fraction values. This field is used with "Zone Minimum Air Flow Fraction". Schedule values are fractions 0.0...',
        },
    )
...
class AirTerminalDualDuctVAVOutdoorAir(IDFBaseModel):
    ...
    maximum_terminal_air_flow_rate: float | Literal['Autosize'] = Field(
        ...,
        json_schema_extra={
            'units': 'm3/s',
    ...
    per_person_ventilation_rate_mode: (
        Literal['CurrentOccupancy', 'DesignOccupancy'] | None
    ) = Field(
        default=None,
        json_schema_extra={
...
class AirTerminalSingleDuctConstantVolumeCooledBeam(IDFBaseModel):
    ...
    supply_air_volumetric_flow_rate: float | Literal['', 'Autosize'] | None = Field(
    ...
    number_of_beams: int | Literal['', 'Autosize'] | None = Field(
        default='Autosize',
        json_schema_extra={'note': 'Number of individual beam units in the zone'},
    )
    beam_length: float | Literal['', 'Autosize'] | None = Field(
        default='Autosize',
        json_schema_extra={'units': 'm', 'note': 'Length of an individual beam unit'},
    )
    design_inlet_water_temperature: float | None = Field(
        default=15.0, ge=0.0, json_schema_extra={'units': 'C'}
    )
    design_outlet_water_temperature: float | None = Field(
        default=17.0, ge=0.0, json_schema_extra={'units': 'C'}
    )
    coil_surface_area_per_coil_length: float | None = Field(
        default=5.422, ge=0.0, json_schema_extra={'units': 'm2/m'}
    )
    ...
    model_parameter_a0: float | None = Field(
        default=0.171,
        ge=0.0,
        json_schema_extra={
            'units': 'm2/m',
    ...
    coefficient_of_induction_kin: float | Literal['', 'Autocalculate'] | None = Field(
        default='Autocalculate'
    )
    leaving_pipe_inside_diameter: float | None = Field(
        default=0.0145, gt=0.0, json_schema_extra={'units': 'm'}
    )
...
class AirTerminalSingleDuctConstantVolumeFourPipeBeam(IDFBaseModel):
    ...
    heating_availability_schedule_name: ScheduleNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['ScheduleNames'],
            'note': 'Heating operation can be controlled separately using this availability schedule. Schedule value > 0 means beam heating is available. If this field is blank, the beam heating is always available (as...',
        },
    )
    ...
    design_primary_air_volume_flow_rate: float | Literal['', 'Autosize'] | None = Field(
        default='Autosize', json_schema_extra={'units': 'm3/s'}
    )
    design_chilled_water_volume_flow_rate: float | Literal['', 'Autosize'] | None = (
        Field(default='Autosize', json_schema_extra={'units': 'm3/s'})
    )
    design_hot_water_volume_flow_rate: float | Literal['', 'Autosize'] | None = Field(
        default='Autosize', json_schema_extra={'units': 'm3/s'}
    )
    zone_total_beam_length: float | Literal['', 'Autosize'] | None = Field(
        default='Autosize',
        json_schema_extra={
            'units': 'm',
    ...
    rated_primary_air_flow_rate_per_beam_length: float | None = Field(
        default=0.035,
        gt=0.0,
        json_schema_extra={
            'units': 'm3/s-m',
    ...
    beam_rated_cooling_capacity_per_beam_length: float | None = Field(
        default=600.0,
        gt=0.0,
        json_schema_extra={
            'units': 'W/m',
    ...
    beam_rated_chilled_water_volume_flow_rate_per_beam_length: float | None = Field(
        default=5e-05,
        gt=0.0,
        json_schema_extra={
            'units': 'm3/s-m',
    ...
    beam_rated_heating_capacity_per_beam_length: float | None = Field(
        default=1500.0,
        gt=0.0,
        json_schema_extra={
            'units': 'W/m',
    ...
    beam_rated_heating_room_air_hot_water_temperature_difference: float | None = Field(
        default=27.8,
        gt=0.0,
        json_schema_extra={
            'units': 'deltaC',
    ...
    beam_rated_hot_water_volume_flow_rate_per_beam_length: float | None = Field(
        default=5e-05,
        gt=0.0,
        json_schema_extra={
            'units': 'm3/s-m',
            'note': 'The volume flow rate of hot water per meter of beam length at the rating point.',
        },
    )
...
class AirTerminalSingleDuctConstantVolumeFourPipeInduction(IDFBaseModel):
    ...
    maximum_total_air_flow_rate: float | Literal['Autosize'] = Field(
        ..., json_schema_extra={'units': 'm3/s'}
    )
    induction_ratio: float | None = Field(
        default=2.5,
        ge=0.0,
        json_schema_extra={
    ...
    supply_air_inlet_node_name: str = Field(...)
    induced_air_inlet_node_name: str = Field(
        ...,
        json_schema_extra={
...
class AirTerminalSingleDuctConstantVolumeNoReheat(IDFBaseModel):
    ...
    air_inlet_node_name: str = Field(
        ...,
        json_schema_extra={
            'note': 'The air-inlet node name that connects the air splitter to the individual zone air distribution unit. This node should also be one of the outlet air node of an AirLoopHVAC:ZoneSplitter or AirLoopHVA...'
        },
    )
    air_outlet_node_name: str = Field(
        ...,
    ...
    design_specification_outdoor_air_object_name: (
        ...
        json_schema_extra={
            'object_list': ['DSOASpaceListNames', 'DesignSpecificationOutdoorAirNames'],
            'note': 'This field is used to modulate the terminal unit flow rate based on the specified outdoor air requirement. When the name of a DesignSpecification:OutdoorAir object is entered, the terminal unit wil...',
        },
    )
    per_person_ventilation_rate_mode: (
        Literal['', 'CurrentOccupancy', 'DesignOccupancy'] | None
...
class AirTerminalSingleDuctConstantVolumeReheat(IDFBaseModel):
    ...
    reheat_coil_object_type: Literal[
...
class AirTerminalSingleDuctMixer(IDFBaseModel):
    ...
    mixer_outlet_node_name: str = Field(
        ...,
        json_schema_extra={
            'note': 'This is the outlet air node name of the mixer. This will be the inlet air node name of the ZoneHVAC equipment if the connection type in the input field Mixer Connection Type below is InletSide, els...'
        },
    )
    mixer_primary_air_inlet_node_name: str = Field(
        ...,
        json_schema_extra={
            'note': 'The primary air (treated outdoor air) inlet node name of the mixer. This will be an outlet air node name of an AirLoopHVAC:ZoneSplitter or AirLoopHVAC:SupplyPlenum providing the connection to the D...'
        },
    )
    mixer_secondary_air_inlet_node_name: str = Field(
        ...,
        json_schema_extra={
            'note': 'The secondary air (recirculating air) inlet node name of the mixer. This will be the outlet air node name of the ZoneHVAC equipment if the connection type in the input field mixer Connection Type b...'
        },
    )
    mixer_connection_type: Literal['InletSide', 'SupplySide'] = Field(
        ...,
        json_schema_extra={
    ...
    design_specification_outdoor_air_object_name: (
        ...
        json_schema_extra={
            'object_list': ['DSOASpaceListNames', 'DesignSpecificationOutdoorAirNames'],
            'note': 'When the name of a DesignSpecification:OutdoorAir object is entered, the terminal unit will adjust flow to meet this outdoor air requirement. If Outdoor Air Flow per Person is non-zero, then the ou...',
        },
    )
    per_person_ventilation_rate_mode: (
        Literal['', 'CurrentOccupancy', 'DesignOccupancy'] | None
...
class AirTerminalSingleDuctParallelPIUReheat(IDFBaseModel):
    ...
    maximum_primary_air_flow_rate: float | Literal['Autosize'] = Field(
        ..., json_schema_extra={'units': 'm3/s'}
    )
    maximum_secondary_air_flow_rate: float | Literal['Autosize'] = Field(
        ..., json_schema_extra={'units': 'm3/s'}
    )
    minimum_primary_air_flow_fraction: float | Literal['Autosize'] = Field(
        ...,
        json_schema_extra={
    ...
    fan_on_flow_fraction: float | Literal['Autosize'] = Field(
        ...,
        json_schema_extra={
    ...
    convergence_tolerance: float | None = Field(default=0.001, gt=0.0)
    fan_control_type: Literal['', 'ConstantSpeed', 'VariableSpeed'] | None = Field(
        default='ConstantSpeed',
        json_schema_extra={
            'note': 'If VariableSpeed, then the fan object type must be Fan:SystemModel'
        },
    )
    minimum_fan_turn_down_ratio: float | None = Field(
        default=0.3,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    design_heating_discharge_air_temperature: float | None = Field(
        ...
        json_schema_extra={
            'units': 'C',
            'note': 'Only used if Heating Control Type is Modulated Used to control second stage heating, typically zone heat setpoint plus 20F',
        },
    )
    high_limit_heating_discharge_air_temperature: float | None = Field(
        default=37.7,
        json_schema_extra={
            'units': 'C',
...
class AirTerminalSingleDuctVAVHeatAndCoolReheat(IDFBaseModel):
    ...
    damper_air_outlet_node_name: str = Field(
        ...,
        json_schema_extra={
...
class AirTerminalSingleDuctVAVNoReheat(IDFBaseModel):
    ...
    constant_minimum_air_flow_fraction: float | Literal['', 'Autosize'] | None = Field(
        default='Autosize',
        json_schema_extra={
    ...
    fixed_minimum_air_flow_rate: float | Literal['', 'Autosize'] | None = Field(
        default='Autosize',
        json_schema_extra={
            'units': 'm3/s',
    ...
    minimum_air_flow_turndown_schedule_name: ScheduleNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['ScheduleNames'],
            'note': 'This field adjusts the design minimum flow rate by multiplying it using this schedule of fraction values. This field can be used with any of the three "Zone Minimum Air Flow Input Method". Schedule...',
        },
    )
...
class AirTerminalSingleDuctVAVReheat(IDFBaseModel):
    ...
    damper_heating_action: (
        Literal['', 'Normal', 'Reverse', 'ReverseWithLimits'] | None
    ) = Field(
        default='ReverseWithLimits',
        json_schema_extra={
            'note': 'Normal means the damper is fixed at the minimum position in heating mode Reverse means the damper can open fully during reheat ReverseWithLimits means the damper will open partially during reheat a...'
        },
    )
    maximum_flow_per_zone_floor_area_during_reheat: (
        ...
        json_schema_extra={
            'units': 'm3/s-m2',
            'note': 'Used only when Reheat Coil Object Type = Coil:Heating:Water and Damper Heating Action = ReverseWithLimits When autocalculating, the maximum flow per zone is set to 0.002032 m3/s-m2 (0.4 cfm/sqft) T...',
        },
    )
    maximum_flow_fraction_during_reheat: float | Literal['', 'Autosize'] | None = Field(
        default='Autosize',
        json_schema_extra={
            'note': 'Used only when Reheat Coil Object Type = Coil:Heating:Water and Damper Heating Action = ReverseWithLimits When autocalculating, the maximum flow fraction is set to the ratio of 0.002032 m3/s-m2 (0....'
        },
    )
    maximum_reheat_air_temperature: float | None = Field(
        default=None,
...
class AirTerminalSingleDuctVAVReheatVariableSpeedFan(IDFBaseModel):
    ...
    maximum_cooling_air_flow_rate: float | Literal['Autosize'] = Field(
        ..., json_schema_extra={'units': 'm3/s'}
    )
    maximum_heating_air_flow_rate: float | Literal['Autosize'] = Field(
        ..., json_schema_extra={'units': 'm3/s'}
    )
    zone_minimum_air_flow_fraction: float = Field(
        ...,
        ge=0.0,
        le=1.0,
        json_schema_extra={'note': 'fraction of cooling air flow rate'},
    )
    ...
    minimum_air_flow_turndown_schedule_name: ScheduleNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['ScheduleNames'],
            'note': 'This field adjusts the fan-off minimum flow rate by multiplying it using this scheduled fraction values. This field is used with "Zone Minimum Air Flow Fraction". Schedule values are fractions 0.0 ...',
        },
    )
...
class ZoneHVACAirDistributionUnit(IDFBaseModel):
    ...
    def design_specification_air_terminal_sizing_object(
        ...
        if idf is None:
            raise RuntimeError('Not bound to IDF')
        return idf._resolve_forward(v, ['DesignSpecificationAirTerminalSizingName'])
...
class ZoneHVACExhaustControl(IDFBaseModel):
    ...
    zone_name: ZoneNamesRef = Field(
        ...
        json_schema_extra={
            'object_list': ['ZoneNames'],
            'note': 'Zone the exhaust inlet node is part of',
        },
    )
    inlet_node_name: str = Field(
        ...,
        json_schema_extra={
            'note': 'Inlet node name for the exhaust. Must be a zone exhaust node.'
        },
    )
    outlet_node_name: str = Field(
        ..., json_schema_extra={'note': 'Outlet node name for the exhaust'}
    )
    design_exhaust_flow_rate: float | Literal['', 'Autosize'] | None = Field(
        default='Autosize', json_schema_extra={'units': 'm3/s'}
    )
    flow_control_type: Literal['', 'FollowSupply', 'Scheduled'] | None = Field(
        default='Scheduled',
    ...
    exhaust_flow_fraction_schedule_name: ScheduleNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['ScheduleNames'],
            'note': 'Schedule name of the exhaust flow fraction. Used only with Scheduled control type. If this field is blank, the flow fraction is always 1.0.',
        },
    )
    supply_node_or_nodelist_name: str | None = Field(
        default=None,
    ...
    balanced_exhaust_fraction_schedule_name: ScheduleNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['ScheduleNames'],
            'note': 'Schedule name of the Balanced Exhaust Fraction.',
        },
    )
