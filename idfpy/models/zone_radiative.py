...
class ZoneHVACBaseboardRadiantConvectiveElectricSurfaceFractionsItem(IDFBaseModel):
    ...
    fraction_of_radiant_energy_to_surface: float | None = Field(
...
class ZoneHVACVentilatedSlabSlabGroupDataItem(IDFBaseModel):
    ...
    core_length_for_surface: float = Field(
        ..., ge=0.0, json_schema_extra={'units': 'm'}
    )
...
class ZoneHVACBaseboardConvectiveElectric(IDFBaseModel):
    ...
    heating_design_capacity_method: (
        ...
        json_schema_extra={
            'note': 'Enter the method used to determine the heating design capacity. HeatingDesignCapacity = > selected when the design heating capacity value or autosize is specified. CapacityPerFloorArea = > selected...'
        },
    )
...
class ZoneHVACBaseboardConvectiveWater(IDFBaseModel):
    ...
    u_factor_times_area_value: float | Literal['Autosize'] = Field(
        ..., json_schema_extra={'units': 'W/K'}
    )
    maximum_water_flow_rate: float | Literal['Autosize'] = Field(
...
class ZoneHVACBaseboardRadiantConvectiveElectric(IDFBaseModel):
    ...
    surface_fractions: (
        list[ZoneHVACBaseboardRadiantConvectiveElectricSurfaceFractionsItem] | None
    ) = Field(default=None)
...
class ZoneHVACBaseboardRadiantConvectiveSteam(IDFBaseModel):
    ...
    degree_of_subcooling: float | None = Field(
        default=5.0, ge=1.0, json_schema_extra={'units': 'deltaC'}
    )
    maximum_steam_flow_rate: float | Literal['Autosize'] = Field(
        ..., json_schema_extra={'units': 'm3/s'}
    )
    surface_fractions: (
        list[ZoneHVACBaseboardRadiantConvectiveElectricSurfaceFractionsItem] | None
...
class ZoneHVACBaseboardRadiantConvectiveSteamDesign(IDFBaseModel):
    ...
    heating_design_capacity_method: (
        ...
        default='HeatingDesignCapacity',
        json_schema_extra={
            'note': 'Enter the method used to determine the heating design capacity. HeatingDesignCapacity is selected when the design heating capacity value or autosize is specified. CapacityPerFloorArea is selected w...'
        },
    )
    heating_design_capacity_per_floor_area: float | None = Field(
        default=None,
...
class ZoneHVACBaseboardRadiantConvectiveWater(IDFBaseModel):
    ...
    inlet_node_name: str = Field(...)
    outlet_node_name: str = Field(...)
    rated_average_water_temperature: float | None = Field(
        default=87.78,
        ge=20.0,
        le=150.0,
        json_schema_extra={
    ...
    rated_water_mass_flow_rate: float | None = Field(
        default=0.063,
        le=10.0,
        gt=0.0,
        json_schema_extra={
            'units': 'kg/s',
            'note': 'Standard is I=B=R Rating document where all baseboards are rated at either 0.063 kg/s (1 gpm) or 0.252 kg/s (4 gpm). It is recommended that users find data for the baseboard heater that corresponds...',
        },
    )
    heating_design_capacity: float | Literal['', 'Autosize'] | None = Field(
        default='Autosize',
        json_schema_extra={
            'units': 'W',
            'note': 'Enter the design heating capacity. Required field when the heating design capacity method HeatingDesignCapacity. This input field is rated heating capacity. Users must multiply the actual finned le...',
        },
    )
    maximum_water_flow_rate: float | Literal['Autosize'] = Field(
        ..., json_schema_extra={'units': 'm3/s'}
...
class ZoneHVACCoolingPanelRadiantConvectiveWater(IDFBaseModel):
    ...
    rated_inlet_space_temperature: float | None = Field(
        default=24.0, json_schema_extra={'units': 'C'}
    )
    rated_water_mass_flow_rate: float | None = Field(
        default=0.063, gt=0.0, json_schema_extra={'units': 'kg/s'}
    )
    cooling_design_capacity_method: (
        ...
        json_schema_extra={
            'note': 'Enter the method used to determine the cooling design capacity for scalable sizing. CoolingDesignCapacity => selected when the design cooling capacity value is specified or auto-sized. CapacityPerF...'
        },
    )
    ...
    maximum_chilled_water_flow_rate: float | Literal['Autosize'] = Field(
        ..., json_schema_extra={'units': 'm3/s'}
    )
    control_type: (
        Literal[
...
class ZoneHVACHighTemperatureRadiant(IDFBaseModel):
    ...
    heating_design_capacity_method: (
        ...
        default='HeatingDesignCapacity',
        json_schema_extra={
            'note': 'Enter the method used to determine the maximum heating power input capacity. HeatingDesignCapacity = > selected when the design heating capacity value or autosize is specified. CapacityPerFloorArea...'
        },
    )
    heating_design_capacity: float | Literal['', 'Autosize'] | None = Field(
        default='Autosize',
    ...
    fuel_type: Literal['Electricity', 'NaturalGas'] = Field(
        ..., json_schema_extra={'note': 'Natural gas or electricity'}
    )
    combustion_efficiency: float | None = Field(
        default=0.9,
        ge=0.0,
        le=1.0,
        json_schema_extra={'note': 'Not used for non-gas radiant heaters'},
    )
    fraction_of_input_converted_to_radiant_energy: float | None = Field(
        default=0.7,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    fraction_of_input_converted_to_latent_energy: float | None = Field(
        default=0.0, ge=0.0, le=1.0
    )
    fraction_of_input_that_is_lost: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={'note': 'Fraction of input vented to outdoor environment'},
    )
    temperature_control_type: (
        ...
        json_schema_extra={'note': 'Temperature type used to control unit'},
    )
...
class ZoneHVACLowTemperatureRadiantConstantFlow(IDFBaseModel):
    ...
    hydronic_tubing_length: float | Literal['', 'Autosize'] | None = Field(
        default='Autosize',
        json_schema_extra={
            'units': 'm',
    ...
    pump_flow_rate_schedule_name: ScheduleNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['ScheduleNames'],
            'note': 'Modifies the Rated Flow Rate of the pump on a time basis the default is that the pump is ON and runs according to its other operational requirements specified above. The schedule is for special pum...',
        },
    )
    rated_pump_head: float | None = Field(
        default=179352.0,
        json_schema_extra={'units': 'Pa', 'note': 'default head is 60 feet'},
    )
    rated_power_consumption: float | None = Field(
    ...
    number_of_circuits: (
        Literal['', 'CalculateFromCircuitLength', 'OnePerSurface'] | None
    ) = Field(default='OnePerSurface')
    circuit_length: float | None = Field(
        default=106.7, json_schema_extra={'units': 'm'}
    )
...
class ZoneHVACLowTemperatureRadiantConstantFlowDesign(IDFBaseModel):
    ...
    fluid_to_radiant_surface_heat_transfer_model: (
        ...
        json_schema_extra={
            'note': 'This parameter identifies how the heat transfer between fluid being circulated through the radiant system and the radiant system (slab) is modeled. ConvectionOnly means that only convection between...'
        },
    )
    hydronic_tubing_inside_diameter: float | None = Field(
        default=0.013, gt=0.0, json_schema_extra={'units': 'm'}
    )
    hydronic_tubing_outside_diameter: float | None = Field(
        default=0.016, gt=0.0, json_schema_extra={'units': 'm'}
    )
    hydronic_tubing_conductivity: float | None = Field(
        default=0.35,
        gt=0.0,
        json_schema_extra={
            'units': 'W/m-K',
    ...
    temperature_control_type: (
        ...
        default='MeanAirTemperature',
        json_schema_extra={'note': 'Temperature used to control system'},
    )
    running_mean_outdoor_dry_bulb_temperature_weighting_factor: float | None = Field(
        default=0.8,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    fraction_of_motor_inefficiencies_to_fluid_stream: float | None = Field(
        default=0.0, ge=0.0, le=1.0
    )
    condensation_control_type: Literal['', 'Off', 'SimpleOff', 'VariableOff'] | None = (
        Field(default='SimpleOff')
    ...
    changeover_delay_time_period_schedule: ScheduleNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['ScheduleNames'],
            'note': 'Changeover delay schedule name for this system. Schedule value <= 0 allows changeover with no delay The schedule values are interpreted as hours. If this field is blank, the system allows changeove...',
        },
    )
...
class ZoneHVACLowTemperatureRadiantElectric(IDFBaseModel):
    ...
    heating_design_capacity_method: (
        ...
        default='HeatingDesignCapacity',
        json_schema_extra={
            'note': 'Enter the method used to determine the maximum electrical heating design capacity. HeatingDesignCapacity = > selected when the design heating capacity value or autosize is specified. CapacityPerFlo...'
        },
    )
    heating_design_capacity: float | Literal['', 'Autosize'] | None = Field(
        default='Autosize',
    ...
    temperature_control_type: (
        ...
        default='MeanAirTemperature',
        json_schema_extra={'note': 'Temperature used to control unit'},
    )
    setpoint_control_type: Literal['', 'HalfFlowPower', 'ZeroFlowPower'] | None = Field(
        default='HalfFlowPower',
        json_schema_extra={'note': 'How setpoint temperature is defined'},
    )
    heating_throttling_range: float | None = Field(
...
class ZoneHVACLowTemperatureRadiantVariableFlow(IDFBaseModel):
    ...
    maximum_hot_water_flow: float | Literal['Autosize'] | None = Field(
        default=None, json_schema_extra={'units': 'm3/s'}
    )
    heating_water_inlet_node_name: str | None = Field(default=None)
    heating_water_outlet_node_name: str | None = Field(default=None)
    ...
    maximum_cold_water_flow: float | Literal['Autosize'] | None = Field(
        default=None, json_schema_extra={'units': 'm3/s'}
    )
    cooling_water_inlet_node_name: str | None = Field(default=None)
    cooling_water_outlet_node_name: str | None = Field(default=None)
...
class ZoneHVACVentilatedSlab(IDFBaseModel):
    ...
    system_configuration_type: (
        Literal['', 'SeriesSlabs', 'SlabAndZone', 'SlabOnly'] | None
    ) = Field(default='SlabOnly')
    hollow_core_inside_diameter: float | None = Field(
        default=0.05, ge=0.0, json_schema_extra={'units': 'm'}
    )
    hollow_core_length: float | None = Field(
        default=None,
        ge=0.0,
        json_schema_extra={
            'units': 'm',
    ...
    number_of_cores: float | None = Field(
        default=None,
        ge=0.0,
        json_schema_extra={'note': 'flow will be divided evenly among the cores'},
    )
    temperature_control_type: (
        Literal[
            '',
    ...
    coil_option_type: Literal['Cooling', 'Heating', 'HeatingAndCooling', 'None'] = (
        Field(...)
    )
