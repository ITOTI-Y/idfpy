...
if TYPE_CHECKING:
    ...
    from .zone_airflow import ZoneVentilationDesignFlowRate, ZoneVentilationWindandStackOpenArea
...
ventilation manager, then zone hybrid ventilation manager is disabled."""
    ...
    @property
    def zoneventilation_object(self) -> ZoneVentilationDesignFlowRate | ZoneVentilationWindandStackOpenArea | None:
