...
if TYPE_CHECKING:
    ...
    from .zone_controls import ZoneControlThermostat, ZoneControlThermostatStagedDualSetpoint
...
class DemandManagerAssignmentListManagerDataItem(IDFBaseModel):
    ...
    @property
    def demandmanager(self) -> DemandManagerElectricEquipment | DemandManagerExteriorLights | DemandManagerLights | DemandManagerThermostats | DemandManagerVentilation | None:
