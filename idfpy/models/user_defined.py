...
Management System or External Interface"""
    ...
    @property
    def plant_connection_1_initialization_program_calling_manager(self) -> IDFBaseModel | None:
    ...
    @property
    def plant_connection_1_simulation_program_calling_manager(self) -> IDFBaseModel | None:
    ...
    @property
    def plant_connection_2_initialization_program_calling_manager(self) -> IDFBaseModel | None:
    ...
    @property
    def plant_connection_2_simulation_program_calling_manager(self) -> IDFBaseModel | None:
    ...
    @property
    def plant_connection_3_initialization_program_calling_manager(self) -> IDFBaseModel | None:
    ...
    @property
    def plant_connection_3_simulation_program_calling_manager(self) -> IDFBaseModel | None:
    ...
    @property
    def plant_connection_4_initialization_program_calling_manager(self) -> IDFBaseModel | None:
    ...
    @property
    def plant_connection_4_simulation_program_calling_manager(self) -> IDFBaseModel | None:
