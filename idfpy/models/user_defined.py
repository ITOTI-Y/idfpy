...
class AirTerminalSingleDuctUserDefined(IDFBaseModel):
    ...
    secondary_air_outlet_node_name: str | None = Field(
        default=None,
...
class CoilUserDefined(IDFBaseModel):
    ...
    air_connection_1_inlet_node_name: str = Field(
        ..., json_schema_extra={'note': 'Inlet air for primary air stream'}
    )
    air_connection_1_outlet_node_name: str = Field(
        ..., json_schema_extra={'note': 'Outlet air for primary air stream'}
    )
    air_connection_2_inlet_node_name: str | None = Field(
        default=None, json_schema_extra={'note': 'Inlet air for secondary air stream'}
    )
    air_connection_2_outlet_node_name: str | None = Field(
        default=None, json_schema_extra={'note': 'Outlet air for secondary air stream'}
    )
...
class PlantComponentUserDefined(IDFBaseModel):
    ...
    plant_connection_1_inlet_node_name: str = Field(...)
    plant_connection_1_outlet_node_name: str = Field(...)
    plant_connection_1_loading_mode: Literal[
        'DemandsLoad',
    ...
    air_connection_outlet_node_name: str | None = Field(
        default=None,
        json_schema_extra={'note': 'Outlet air used for heat rejection or air source'},
    )
    supply_inlet_water_storage_tank_name: WaterStorageTankNamesRef | None = Field(
