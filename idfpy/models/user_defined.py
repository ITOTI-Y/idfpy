...
Energy Management System or External Interface"""
    ...
    @property
    def overall_model_simulation_program_calling_manager(self) -> EnergyManagementSystemProgramCallingManager | PythonPluginInstance | None:
    ...
    @property
    def model_setup_and_sizing_program_calling_manager(self) -> EnergyManagementSystemProgramCallingManager | PythonPluginInstance | None:
...
Management System or External Interface"""
    ...
    @property
    def main_model_program_calling_manager(self) -> EnergyManagementSystemProgramCallingManager | PythonPluginInstance | None:
    ...
    @property
    def plant_connection_1_initialization_program_calling_manager(self) -> EnergyManagementSystemProgramCallingManager | PythonPluginInstance | None:
    ...
    @property
    def plant_connection_1_simulation_program_calling_manager(self) -> EnergyManagementSystemProgramCallingManager | PythonPluginInstance | None:
    ...
    @property
    def plant_connection_2_initialization_program_calling_manager(self) -> EnergyManagementSystemProgramCallingManager | PythonPluginInstance | None:
    ...
    @property
    def plant_connection_2_simulation_program_calling_manager(self) -> EnergyManagementSystemProgramCallingManager | PythonPluginInstance | None:
    ...
    @property
    def plant_connection_3_initialization_program_calling_manager(self) -> EnergyManagementSystemProgramCallingManager | PythonPluginInstance | None:
    ...
    @property
    def plant_connection_3_simulation_program_calling_manager(self) -> EnergyManagementSystemProgramCallingManager | PythonPluginInstance | None:
    ...
    @property
    def plant_connection_4_initialization_program_calling_manager(self) -> EnergyManagementSystemProgramCallingManager | PythonPluginInstance | None:
    ...
    @property
    def plant_connection_4_simulation_program_calling_manager(self) -> EnergyManagementSystemProgramCallingManager | PythonPluginInstance | None:
...
using Energy Management System or External Interface to dispatch loads"""
    ...
    @property
    def initialization_program_calling_manager(self) -> EnergyManagementSystemProgramCallingManager | PythonPluginInstance | None:
