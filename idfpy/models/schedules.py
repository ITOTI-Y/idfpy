...
class ScheduleWeekCompactDataItem(IDFBaseModel):
    ...
    @property
    def schedule_day(self) -> ScheduleDayHourly | ScheduleDayInterval | ScheduleDayList | None:
...
day type."""
    ...
    @property
    def sunday_schedule_day(self) -> ScheduleDayHourly | ScheduleDayInterval | ScheduleDayList | None:
    ...
    @property
    def monday_schedule_day(self) -> ScheduleDayHourly | ScheduleDayInterval | ScheduleDayList | None:
    ...
    @property
    def tuesday_schedule_day(self) -> ScheduleDayHourly | ScheduleDayInterval | ScheduleDayList | None:
    ...
    @property
    def wednesday_schedule_day(self) -> ScheduleDayHourly | ScheduleDayInterval | ScheduleDayList | None:
    ...
    @property
    def thursday_schedule_day(self) -> ScheduleDayHourly | ScheduleDayInterval | ScheduleDayList | None:
    ...
    @property
    def friday_schedule_day(self) -> ScheduleDayHourly | ScheduleDayInterval | ScheduleDayList | None:
    ...
    @property
    def saturday_schedule_day(self) -> ScheduleDayHourly | ScheduleDayInterval | ScheduleDayList | None:
    ...
    @property
    def holiday_schedule_day(self) -> ScheduleDayHourly | ScheduleDayInterval | ScheduleDayList | None:
    ...
    @property
    def summerdesignday_schedule_day(self) -> ScheduleDayHourly | ScheduleDayInterval | ScheduleDayList | None:
    ...
    @property
    def winterdesignday_schedule_day(self) -> ScheduleDayHourly | ScheduleDayInterval | ScheduleDayList | None:
    ...
    @property
    def customday1_schedule_day(self) -> ScheduleDayHourly | ScheduleDayInterval | ScheduleDayList | None:
    ...
    @property
    def customday2_schedule_day(self) -> ScheduleDayHourly | ScheduleDayInterval | ScheduleDayList | None:
