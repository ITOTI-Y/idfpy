...
FIELD_ORDER_REGISTRY: dict[str, list[str]] = {
    ...
    "Duct:Loss:Leakage": ["name", "airloophvac_name", "airflownetwork_distribution_linkage_name"],
    "Duct:Loss:MakeupAir": ["name", "airloophvac_name", "airflownetwork_distribution_linkage_name"],
    "ElectricEquipment": [
        "name",
    ...
    "Output:SQLite": ["option_type", "unit_conversion_for_tabular_data", "format_numeric_values_for_tabular_data"],
    ...
    "OutputControl:Table:Style": ["column_separator", "unit_conversion", "format_numeric_values"],
