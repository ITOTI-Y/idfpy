...
class PythonPluginInstance(IDFBaseModel):
    ...
    run_during_warmup_days: Literal['', 'No', 'Yes'] | None = Field(
        default='No',
        json_schema_extra={
    ...
    python_module_name: str = Field(
        ...,
        json_schema_extra={
            'note': 'This is the name of the Python file, without a file extension. For "plugin_b.py", use just "plugin_b". The Python plugin file must be on the plugin system search path to be found during a simulatio...'
        },
    )
...
class PythonPluginOutputVariable(IDFBaseModel):
    ...
    type_of_data_in_variable: Literal['Averaged', 'Metered', 'Summed'] = Field(
        ...,
        json_schema_extra={
    ...
    resource_type: (
        ...
        default=None,
        json_schema_extra={
            'note': 'This field is optional for regular output variables with "Type of Data in Variable" set to either Averaged or Summed. For Metered variables, this field is required. Choose the type of fuel, water, ...'
        },
    )
    group_type: Literal['Building', 'HVAC', 'Plant', 'System'] | None = Field(
        default=None,
        json_schema_extra={
            'note': 'This field is optional for regular output variables with "Type of Data in Variable" set to either Averaged or Summed. For Metered variables, this field is required. Choose a general classification,...'
        },
    )
    end_use_category: (
        Literal[
        ...
        default=None,
        json_schema_extra={
            'note': 'This field is optional for regular output variables with "Type of Data in Variable" set to either Averaged or Summed. For Metered variables, this field is required. Choose how the metered output sh...'
        },
    )
    end_use_subcategory: str | None = Field(
        default=None,
        json_schema_extra={
            'note': 'This field is always optional. For regular output variables with "Type of Data in Variable" set to either Averaged or Summed, this field is completely ignored. For Metered variables, this field is ...'
        },
    )
...
class PythonPluginSearchPaths(IDFBaseModel):
    ...
    add_input_file_directory_to_search_path: Literal['', 'No', 'Yes'] | None = Field(
        default='Yes',
        json_schema_extra={
    ...
    add_epin_environment_variable_to_search_path: Literal['', 'No', 'Yes'] | None = (
        Field(
            default='Yes',
            json_schema_extra={
                'note': 'The "epin" environment variable is set by some EnergyPlus interfaces in order to let EnergyPlus find external files in special locations. If this is enabled, and that variable is set, the value of ...'
            },
        )
    )
    py_search_paths: list[PythonPluginSearchPathsPySearchPathsItem] | None = Field(
        default=None
    )
...
class PythonPluginVariables(IDFBaseModel):
    ...
    global_py_vars: list[PythonPluginVariablesGlobalPyVarsItem] | None = Field(
        default=None
    )
