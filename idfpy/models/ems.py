...
class EnergyManagementSystemGlobalVariableVariablesItem(IDFBaseModel):
    ...
    erl_variable_name: str = Field(
        ..., json_schema_extra={'note': 'no spaces allowed in name'}
    )
...
class EnergyManagementSystemGlobalVariable(IDFBaseModel):
    ...
    variables: list[EnergyManagementSystemGlobalVariableVariablesItem] | None = Field(
        default=None
    )
...
class EnergyManagementSystemMeteredOutputVariable(IDFBaseModel):
    ...
    ems_program_or_subroutine_name: str | None = Field(
        default=None,
        json_schema_extra={
...
class EnergyManagementSystemProgramCallingManager(IDFBaseModel):
    ...
    programs: list[EnergyManagementSystemProgramCallingManagerProgramsItem] | None = (
        Field(default=None)
    )
