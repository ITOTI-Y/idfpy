...
dynamically updated from the FMU."""
    ...
    actuated_component_control_type: str = Field(...)
    fmu_variable_name: str = Field(...)
    initial_value: float | None = Field(default=None, json_schema_extra={'note': 'Used during EnergyPlus sizing and warm-up. If no value is specified, then the actuated component will only be updated after sizing and warm-up.'})
...
EnergyPlus"""
    ...
    fmu_variable_name: str = Field(...)
    initial_value: float | None = Field(default=None, json_schema_extra={'note': 'Used during EnergyPlus sizing and warm-up.'})
...
for Erl variables"""
    ...
    name: str = Field(..., json_schema_extra={'note': 'This name becomes a variable for use in Erl programs no spaces allowed in name'})
    fmu_variable_name: str = Field(...)
    initial_value: float = Field(..., json_schema_extra={'note': 'Used during EnergyPlus sizing and warm-up.'})
