...
class ZoneCoolTowerShower(IDFBaseModel):
    ...
    effective_tower_height: float = Field(
        ...,
        json_schema_extra={
            'units': 'm',
    ...
    airflow_outlet_area: float = Field(
        ...,
        json_schema_extra={
            'units': 'm2',
    ...
    maximum_air_flow_rate: float = Field(
        ..., ge=0.0, json_schema_extra={'units': 'm3/s'}
    )
    minimum_indoor_temperature: float = Field(
        ...,
        ge=-100.0,
        le=100.0,
        json_schema_extra={
...
class ZoneCrossMixing(IDFBaseModel):
    ...
    schedule_name: ScheduleNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['ScheduleNames'],
            'note': 'If blank, defaults to always 1.0',
        },
    )
    design_flow_rate_calculation_method: (
        Literal['', 'AirChanges/Hour', 'Flow/Area', 'Flow/Person', 'Flow/Zone'] | None
    ) = Field(
        default='Flow/Zone',
        json_schema_extra={
    ...
    flow_rate_per_floor_area: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm3/s-m2'}
    )
    flow_rate_per_person: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm3/s-person'}
    )
...
class ZoneEarthtube(IDFBaseModel):
    ...
    design_flow_rate: float = Field(
        ...,
        ge=0.0,
        json_schema_extra={'units': 'm3/s', 'note': '"Edesign" in Equation'},
    )
    minimum_zone_temperature_when_cooling: float = Field(
        ...,
        ge=-100.0,
        le=100.0,
        json_schema_extra={
    ...
    maximum_zone_temperature_when_heating: float = Field(
        ...,
        ge=-100.0,
        le=100.0,
        json_schema_extra={
    ...
    earthtube_type: Literal['', 'Exhaust', 'Intake', 'Natural'] | None = Field(
        default='Natural'
    )
    fan_pressure_rise: float | None = Field(
        default=0.0,
        ge=0.0,
        json_schema_extra={'units': 'Pa', 'note': 'pressure rise across the fan'},
    )
    fan_total_efficiency: float | None = Field(default=1.0, gt=0.0)
    pipe_radius: float | None = Field(
        default=1.0, gt=0.0, json_schema_extra={'units': 'm'}
    )
    pipe_thickness: float | None = Field(
        default=0.2, gt=0.0, json_schema_extra={'units': 'm'}
    )
    pipe_length: float | None = Field(
        default=15.0, gt=0.0, json_schema_extra={'units': 'm'}
    )
    pipe_thermal_conductivity: float | None = Field(
        default=200.0, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    pipe_depth_under_ground_surface: float | None = Field(
        default=3.0, gt=0.0, json_schema_extra={'units': 'm'}
    )
    soil_condition: (
        Literal['', 'HeavyAndDamp', 'HeavyAndDry', 'HeavyAndSaturated', 'LightAndDry']
        | None
    ) = Field(default='HeavyAndDamp')
    average_soil_surface_temperature: float = Field(
        ..., json_schema_extra={'units': 'C'}
    )
    amplitude_of_soil_surface_temperature: float = Field(
        ..., ge=0.0, json_schema_extra={'units': 'deltaC'}
    )
    phase_constant_of_soil_surface_temperature: float = Field(
        ..., ge=0.0, json_schema_extra={'units': 'days'}
    )
    constant_term_flow_coefficient: float | None = Field(
        default=1.0, json_schema_extra={'note': '"A" in Equation'}
    )
    temperature_term_flow_coefficient: float | None = Field(
        default=0.0, json_schema_extra={'note': '"B" in Equation'}
    )
    velocity_term_flow_coefficient: float | None = Field(
        default=0.0, json_schema_extra={'note': '"C" in Equation'}
    )
    velocity_squared_term_flow_coefficient: float | None = Field(
        default=0.0, json_schema_extra={'note': '"D" in Equation'}
    )
...
class ZoneEarthtubeParameters(IDFBaseModel):
    ...
    nodes_below_earth_tube: int | None = Field(
        default=3, ge=3, le=10, json_schema_extra={'units': 'dimensionless'}
    )
    earth_tube_dimensionless_boundary_above: float | None = Field(
        default=1.0,
        ge=0.25,
        le=1.0,
        json_schema_extra={
            'units': 'dimensionless',
            'note': 'When set to 1.0, the total thickness of the solution space above the earth tube node is equal to the maximum vertical dimension above the earth tube.',
        },
    )
    earth_tube_dimensionless_boundary_below: float | None = Field(
        default=0.25,
        ge=0.25,
        le=1.0,
        json_schema_extra={
            'units': 'dimensionless',
            'note': 'When set to 1.0, the total thickness of the solution space below the earth tube node is equal to the maximum vertical dimension above the earth tube.',
        },
    )
    earth_tube_solution_space_width: float | None = Field(
        default=4.0,
        ge=3.0,
        le=20.0,
        json_schema_extra={
            'units': 'dimensionless',
            'note': 'Width of the nodes in the direction parallel to the ground, multiplied by earth tube radius',
        },
    )
...
class ZoneInfiltrationDesignFlowRate(IDFBaseModel):
    ...
    flow_rate_per_exterior_surface_area: float | None = Field(
        default=None,
        ge=0.0,
        json_schema_extra={
            'units': 'm3/s-m2',
    ...
    constant_term_coefficient: float | None = Field(
        default=1.0, json_schema_extra={'note': '"A" in Equation'}
    )
    temperature_term_coefficient: float | None = Field(
        default=0.0, json_schema_extra={'note': '"B" in Equation'}
    )
    velocity_term_coefficient: float | None = Field(
        default=0.0, json_schema_extra={'note': '"C" in Equation'}
    )
    velocity_squared_term_coefficient: float | None = Field(
        default=0.0, json_schema_extra={'note': '"D" in Equation'}
    )
    density_basis: Literal['', 'Indoor', 'Outdoor', 'Standard'] | None = Field(
        default='Outdoor',
        json_schema_extra={
            'note': 'The air density to use when converting from volume flow to mass flow.'
        },
    )
...
class ZoneInfiltrationEffectiveLeakageArea(IDFBaseModel):
    ...
    effective_air_leakage_area: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'cm2',
    ...
    stack_coefficient: float = Field(
        ..., gt=0.0, json_schema_extra={'note': '"Cs" in Equation'}
    )
    wind_coefficient: float = Field(
...
class ZoneInfiltrationFlowCoefficient(IDFBaseModel):
    ...
    flow_coefficient: float = Field(
        ..., gt=0.0, json_schema_extra={'note': '"c" in Equation'}
    )
    stack_coefficient: float = Field(
        ..., gt=0.0, json_schema_extra={'note': '"Cs" in Equation'}
    )
    pressure_exponent: float | None = Field(
        default=0.67, gt=0.0, json_schema_extra={'note': '"n" in Equation'}
    )
    wind_coefficient: float = Field(
        ..., gt=0.0, json_schema_extra={'note': '"Cw" in Equation'}
    )
...
class ZoneRefrigerationDoorMixing(IDFBaseModel):
    ...
    schedule_name: ScheduleNamesRef = Field(
        ...
        json_schema_extra={
            'object_list': ['ScheduleNames'],
            'note': 'This schedule defines the fraction of the time the refrigeration door is open For example, if the warehouse is closed at night and there are no door openings between two zones, the value for that t...',
        },
    )
    door_height: float | None = Field(
        default=3.0, ge=0.0, le=50.0, json_schema_extra={'units': 'm'}
    )
    door_area: float | None = Field(
        default=9.0, ge=0.0, le=400.0, json_schema_extra={'units': 'm2'}
    )
    door_protection_type: Literal['', 'AirCurtain', 'None', 'StripCurtain'] | None = (
        Field(
            default='None',
            json_schema_extra={
                'note': 'Door protection can reduce the air flow through a refrigeration door The default value is "None" Choices: "None", "AirCurtain", and "StripCurtain" A strip curtain reduces the air flow more than an ...'
            },
        )
    )

    @property
    def zone_or_space_name_1_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_2_ref(self) -> IDFBaseModel | None:
...
class ZoneThermalChimney(IDFBaseModel):
    ...
    width_of_the_absorber_wall: float = Field(
        ..., ge=0.0, json_schema_extra={'units': 'm'}
    )
    cross_sectional_area_of_air_channel_outlet: float = Field(
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_1: float | None = Field(
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_2: float | None = Field(
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_3: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_4: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_5: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_6: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_7: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_8: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_9: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_10: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_11: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_12: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_13: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_14: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_15: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_16: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_17: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_18: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_19: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    ...
    relative_ratios_of_air_flow_rates_passing_through_inlet_20: float | None = Field(
        default=None, ge=0.0, le=1.0
    )
    cross_sectional_areas_of_air_channel_inlet_20: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2'}
    )
    ...
    @property
    def zone_or_space_name_3_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_4_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_5_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_6_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_7_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_8_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_9_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_10_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_11_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_12_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_13_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_14_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_15_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_16_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_17_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_18_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_19_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_or_space_name_20_ref(self) -> IDFBaseModel | None:
...
class ZoneVentilationDesignFlowRate(IDFBaseModel):
    ...
    ventilation_type: Literal['', 'Balanced', 'Exhaust', 'Intake', 'Natural'] | None = (
        Field(default='Natural')
    )
    fan_pressure_rise: float | None = Field(
        default=0.0,
        ge=0.0,
    ...
    minimum_indoor_temperature: float | None = Field(
        default=-100.0,
        ge=-100.0,
        le=100.0,
        json_schema_extra={
    ...
    maximum_indoor_temperature: float | None = Field(
        default=100.0,
        ge=-100.0,
        le=100.0,
        json_schema_extra={
    ...
    minimum_outdoor_temperature: float | None = Field(
        default=-100.0,
        ge=-100.0,
        le=100.0,
        json_schema_extra={
    ...
    maximum_outdoor_temperature: float | None = Field(
        default=100.0,
        ge=-100.0,
        le=100.0,
        json_schema_extra={
...
class ZoneVentilationWindandStackOpenArea(IDFBaseModel):
    ...
    opening_area_fraction_schedule_name: ScheduleNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['ScheduleNames'],
            'note': 'This schedule contains the fraction values applied to the opening area given in the previous input field (0.0 - 1.0). If blank, defaults to always 1.0',
        },
    )
    opening_effectiveness: float | Literal['', 'Autocalculate'] | None = Field(
        default='Autocalculate',
        json_schema_extra={
            'units': 'dimensionless',
            'note': 'This field is used to calculate wind driven ventilation. "Cw" in the wind-driven equation and the maximum value is 1.0. When the input is Autocalculate, the program calculates Cw based on an angle ...',
        },
    )
    effective_angle: float | None = Field(
        default=0.0,
        ge=0.0,
        lt=360.0,
        json_schema_extra={
    ...
    height_difference: float | None = Field(
        default=0.0,
        ge=0.0,
        json_schema_extra={
            'units': 'm',
    ...
    discharge_coefficient_for_opening: float | Literal['', 'Autocalculate'] | None = (
        Field(
            default='Autocalculate',
            json_schema_extra={
                'note': 'This is the discharge coefficient used to calculate stack effect. "Cd" in the stack equation and the maximum value is 1.0. When the input is Autocalculate, the following equation is used to calcula...'
            },
        )
    )
    minimum_indoor_temperature: float | None = Field(
