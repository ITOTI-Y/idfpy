...
class SpaceTagsItem(IDFBaseModel):
    ...
    tag: str | None = Field(
        default=None, json_schema_extra={'note': 'Optional reporting tag'}
    )
...
class WindowShadingControlFenestrationSurfacesItem(IDFBaseModel):
    ...
    fenestration_surface_name: GlazedExtSubSurfNamesRef = Field(
        ...
        json_schema_extra={
            ...
            'note': 'When Multiple Surface Control Type is set to Sequential the shades will be deployed for the referenced surface objects in order. When that field is set to Group the entire list is controlled simult...',
        },
    )
...
class BuildingSurfaceDetailed(IDFBaseModel):
    ...
    outside_boundary_condition_object: OutFaceEnvNamesRef | None = Field(
        ...
        json_schema_extra={
            ...
            'note': 'Non-blank only if the field Outside Boundary Condition is Surface, Zone, Space, OtherSideCoefficients or OtherSideConditionsModel If Surface, specify name of corresponding surface in adjacent zone ...',
        },
    )
    sun_exposure: Literal['', 'NoSun', 'SunExposed'] | None = Field(
        default='SunExposed'
    )
    wind_exposure: Literal['', 'NoWind', 'WindExposed'] | None = Field(
        default='WindExposed'
    )
    view_factor_to_ground: float | Literal['', 'Autocalculate'] | None = Field(
    ...
    number_of_vertices: float | Literal['', 'Autocalculate'] | None = Field(
        default='Autocalculate',
        json_schema_extra={
            'note': 'shown with 120 vertex coordinates -- extensible object "extensible" -- duplicate last set of x,y,z coordinates (last 3 fields), remembering to remove ; from "inner" fields. for clarity in any error...'
        },
    )
...
class CeilingAdiabatic(IDFBaseModel):
    ...
    starting_x_coordinate: float | None = Field(
        default=None,
        json_schema_extra={
            'units': 'm',
    ...
    starting_y_coordinate: float | None = Field(
        default=None, json_schema_extra={'units': 'm'}
    )
    starting_z_coordinate: float | None = Field(
        default=None, json_schema_extra={'units': 'm'}
    )
    length: float | None = Field(
        default=None, json_schema_extra={'units': 'm', 'note': 'Along X Axis'}
    )
...
class DoorInterzone(IDFBaseModel):
    ...
    outside_boundary_condition_object: OutFaceEnvNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['OutFaceEnvNames'],
            'note': 'Specify a surface name in an adjacent zone for known interior doors. Specify a zone name of an adjacent zone to automatically generate the interior door in the adjacent zone. a blank field will set...',
        },
    )
    multiplier: float | None = Field(
        default=1.0,
...
class FenestrationSurfaceDetailed(IDFBaseModel):
    ...
    outside_boundary_condition_object: OutFaceEnvNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['OutFaceEnvNames'],
            'note': "Non-blank only if base surface field Outside Boundary Condition is Surface or OtherSideCoefficients If Base Surface's Surface, specify name of corresponding subsurface in adjacent zone or specify c...",
        },
    )
    view_factor_to_ground: float | Literal['', 'Autocalculate'] | None = Field(
        default='Autocalculate',
    ...
    frame_and_divider_name: WindowFrameAndDividerNamesRef | None = Field(
        ...
        json_schema_extra={
            ...
            'note': 'Enter the name of a WindowProperty:FrameAndDivider object Used only for exterior windows (rectangular) and glass doors. Unused for triangular windows. If not specified (blank), window or glass door...',
        },
    )
    multiplier: float | None = Field(
        default=1.0,
    ...
    number_of_vertices: float | Literal['', 'Autocalculate'] | None = Field(
        default='Autocalculate',
        json_schema_extra={
            'note': 'vertices are given in GlobalGeometryRules coordinates -- if relative, all surface coordinates are "relative" to the Zone Origin. If world, then building and zone origins are used for some internal ...'
        },
    )
    ...
    vertex_4_x_coordinate: float | None = Field(
        default=None, json_schema_extra={'units': 'm', 'note': 'Not used for triangles'}
    )
    vertex_4_y_coordinate: float | None = Field(
        default=None, json_schema_extra={'units': 'm', 'note': 'Not used for triangles'}
    )
    vertex_4_z_coordinate: float | None = Field(
        default=None, json_schema_extra={'units': 'm', 'note': 'Not used for triangles'}
    )
...
class FloorAdiabatic(IDFBaseModel):
    ...
    azimuth_angle: float | None = Field(
        default=None, ge=0.0, le=360.0, json_schema_extra={'units': 'deg'}
    )
    tilt_angle: float | None = Field(
        default=180.0,
        ge=0.0,
...
class FloorDetailed(IDFBaseModel):
    ...
    number_of_vertices: float | Literal['', 'Autocalculate'] | None = Field(
        default='Autocalculate',
        json_schema_extra={
            'note': 'shown with 10 vertex coordinates -- extensible object "extensible" -- duplicate last set of x,y,z coordinates, renumbering please (and changing z terminator to a comma "," for all but last one whic...'
        },
    )
    vertices: list[BuildingSurfaceDetailedVerticesItem] | None = Field(default=None)
...
class GeometryTransform(IDFBaseModel):
    ...
    plane_of_transform: Literal['', 'XY'] | None = Field(
        default='XY', json_schema_extra={'note': 'only current allowed value is "XY"'}
    )
    current_aspect_ratio: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={'note': 'Aspect ratio of building as described in idf'},
    )
    new_aspect_ratio: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={'note': 'Aspect ratio to transform to during run'},
    )
...
class GlobalGeometryRules(IDFBaseModel):
    ...
    rectangular_surface_coordinate_system: Literal['', 'Relative', 'World'] | None = (
        Field(
            default='Relative',
            json_schema_extra={
...
class InternalMass(IDFBaseModel):
    ...
    space_or_spacelist_name: SpaceAndSpaceListNamesRef | None = Field(
        ...
        json_schema_extra={
            ...
            'note': 'Space(s) the surface is a part of. This field is ignored when a ZoneList Name is specified for Zone or ZoneList Name. An internal mass surface will be added to every Space in every Zone in the Zone...',
        },
    )
...
class Roof(IDFBaseModel):
    ...
    tilt_angle: float | None = Field(
        ...
        ge=0.0,
        le=180.0,
        json_schema_extra={'units': 'deg', 'note': 'Flat Roofs are tilted 0 degrees'},
    )
    starting_x_coordinate: float | None = Field(
        default=None,
        json_schema_extra={
...
class ShadingBuilding(IDFBaseModel):
    ...
    tilt_angle: float | None = Field(
        default=90.0, ge=0.0, le=180.0, json_schema_extra={'units': 'deg'}
    )
    starting_x_coordinate: float | None = Field(
        default=None,
        json_schema_extra={
...
class ShadingBuildingDetailed(IDFBaseModel):
    ...
    number_of_vertices: float | Literal['', 'Autocalculate'] | None = Field(
        default='Autocalculate',
        json_schema_extra={
            'note': 'shown with 6 vertex coordinates -- extensible object Rules for vertices are given in GlobalGeometryRules coordinates -- For this object all surface coordinates are relative to the building origin (...'
        },
    )
    vertices: list[BuildingSurfaceDetailedVerticesItem] | None = Field(default=None)
...
class ShadingFin(IDFBaseModel):
    ...
    left_distance_above_top_of_window: float | None = Field(
        default=None, json_schema_extra={'units': 'm'}
    )
    left_distance_below_bottom_of_window: float | None = Field(
        default=None,
        json_schema_extra={
            'units': 'm',
    ...
    left_tilt_angle_from_window_door: float | None = Field(
        default=90.0, ge=0.0, le=180.0, json_schema_extra={'units': 'deg'}
    )
    left_depth: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm'}
    )
    right_extension_from_window_door: float | None = Field(
        default=None, json_schema_extra={'units': 'm'}
    )
    right_distance_above_top_of_window: float | None = Field(
        default=None, json_schema_extra={'units': 'm'}
    )
    right_distance_below_bottom_of_window: float | None = Field(
        default=None,
        json_schema_extra={
            'units': 'm',
    ...
    right_tilt_angle_from_window_door: float | None = Field(
        default=90.0, ge=0.0, le=180.0, json_schema_extra={'units': 'deg'}
    )
...
class ShadingFinProjection(IDFBaseModel):
    ...
    left_depth_as_fraction_of_window_door_width: float | None = Field(
    ...
    right_depth_as_fraction_of_window_door_width: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
...
class ShadingOverhang(IDFBaseModel):
    ...
    tilt_angle_from_window_door: float | None = Field(
        default=90.0, ge=0.0, le=180.0, json_schema_extra={'units': 'deg'}
    )
    left_extension_from_window_door_width: float | None = Field(
        default=None, json_schema_extra={'units': 'm'}
    )
    right_extension_from_window_door_width: float | None = Field(
        default=None,
        json_schema_extra={
            'units': 'm',
...
class ShadingOverhangProjection(IDFBaseModel):
    ...
    depth_as_fraction_of_window_door_height: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
...
class ShadingPropertyReflectance(IDFBaseModel):
    ...
    diffuse_visible_reflectance_of_unglazed_part_of_shading_surface: float | None = (
        Field(default=0.2, ge=0.0, le=1.0)
    )
    fraction_of_shading_surface_that_is_glazed: float | None = Field(
        default=0.0, ge=0.0, le=1.0
    )
    glazing_construction_name: str | None = Field(
        default=None,
        json_schema_extra={
...
class ShadingZoneDetailed(IDFBaseModel):
    ...
    number_of_vertices: float | Literal['', 'Autocalculate'] | None = Field(
        default='Autocalculate',
        json_schema_extra={
            'note': 'shown with 6 vertex coordinates -- extensible object vertices are given in GlobalGeometryRules coordinates -- if relative, all surface coordinates are "relative" to the Zone Origin. if world, then ...'
        },
    )
    vertices: list[BuildingSurfaceDetailedVerticesItem] | None = Field(default=None)
...
class Space(IDFBaseModel):
    ...
    ceiling_height: float | Literal['', 'Autocalculate'] | None = Field(
        ...
        json_schema_extra={
            'units': 'm',
            'note': 'If this field is 0.0, negative or autocalculate, then the average height of the space is automatically calculated and used in subsequent calculations. If this field is positive, then the number ent...',
        },
    )
    volume: float | Literal['', 'Autocalculate'] | None = Field(
        default='Autocalculate',
        json_schema_extra={
            'units': 'm3',
            'note': 'If this field is 0.0, negative or autocalculate, then the volume of the space is automatically calculated and used in subsequent calculations. If this field is positive, then the number entered her...',
        },
    )
    floor_area: float | Literal['', 'Autocalculate'] | None = Field(
        default='Autocalculate',
        json_schema_extra={
            'units': 'm2',
            'note': 'If this field is 0.0, negative or autocalculate, then the floor area of the space is automatically calculated and used in subsequent calculations. If this field is positive, then the number entered...',
        },
    )
...
class SpaceList(IDFBaseModel):
    ...
    name: str = Field(
        ...,
        json_schema_extra={
            'note': 'Name of the SpaceList. This name must be unique across Zone, Space, ZoneList, and SpaceList names.'
        },
    )
...
class WindowInterzone(IDFBaseModel):
    ...
    outside_boundary_condition_object: OutFaceEnvNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['OutFaceEnvNames'],
            'note': 'Specify a surface name in an adjacent zone for known interior windows. Specify a zone name of an adjacent zone to automatically generate the interior window in the adjacent zone. a blank field will...',
        },
    )
    multiplier: float | None = Field(
        default=1.0,
...
class WindowPropertyAirflowControl(IDFBaseModel):
    ...
    airflow_source: Literal['', 'IndoorAir', 'OutdoorAir'] | None = Field(
        default='IndoorAir'
    )
    airflow_destination: Literal['', 'IndoorAir', 'OutdoorAir', 'ReturnAir'] | None = (
        Field(
            default='OutdoorAir',
            json_schema_extra={
    ...
    airflow_control_type: (
        Literal['', 'AlwaysOff', 'AlwaysOnAtMaximumFlow', 'ScheduledOnly'] | None
    ) = Field(
    ...
    airflow_is_scheduled: Literal['', 'No', 'Yes'] | None = Field(
        default='No',
        json_schema_extra={
    ...
    airflow_return_air_node_name: str | None = Field(
        default=None,
        json_schema_extra={
...
class WindowPropertyFrameAndDivider(IDFBaseModel):
    ...
    frame_outside_projection: float | None = Field(
        default=0.0,
        ge=0.0,
        le=0.5,
        json_schema_extra={
    ...
    frame_inside_projection: float | None = Field(
        default=0.0,
        ge=0.0,
        le=0.5,
        json_schema_extra={
    ...
    frame_solar_absorptance: float | None = Field(
        default=0.7,
        ge=0.0,
        le=1.0,
        json_schema_extra={'note': 'Assumed same on outside and inside of frame'},
    )
    frame_visible_absorptance: float | None = Field(
        default=0.7,
        ge=0.0,
        le=1.0,
        json_schema_extra={'note': 'Assumed same on outside and inside of frame'},
    )
    frame_thermal_hemispherical_emissivity: float | None = Field(
        default=0.9,
        gt=0.0,
        json_schema_extra={'note': 'Assumed same on outside and inside of frame'},
    )
    divider_type: Literal['', 'DividedLite', 'Suspended'] | None = Field(
        default='DividedLite'
    )
    divider_width: float | None = Field(
        default=0.0,
        ge=0.0,
        le=0.5,
        json_schema_extra={
    ...
    divider_inside_projection: float | None = Field(
        default=0.0,
        ge=0.0,
        le=0.5,
        json_schema_extra={
    ...
    divider_conductance: float | None = Field(
        default=0.0,
        ge=0.0,
        json_schema_extra={
            'units': 'W/m2-K',
    ...
    divider_solar_absorptance: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={'note': 'Assumed same on outside and inside of divider'},
    )
    divider_visible_absorptance: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={'note': 'Assumed same on outside and inside of divider'},
    )
    divider_thermal_hemispherical_emissivity: float | None = Field(
        default=0.9,
        gt=0.0,
        lt=1.0,
        json_schema_extra={'note': 'Assumed same on outside and inside of divider'},
    ...
    inside_sill_depth: float | None = Field(
        default=0.0, ge=0.0, le=2.0, json_schema_extra={'units': 'm'}
    )
    inside_sill_solar_absorptance: float | None = Field(default=0.0, ge=0.0, le=1.0)
    inside_reveal_depth: float | None = Field(
        default=0.0,
        ge=0.0,
        le=2.0,
        json_schema_extra={
            'units': 'm',
            'note': 'Distance from plane of inside surface of glazing to plane of inside surface of wall. Outside reveal depth is determined from the geometry of the window and the wall it is on; it is non-zero if the ...',
        },
    )
    ...
    nfrc_product_type_for_assembly_calculations: (
        ...
        default='CurtainWall',
        json_schema_extra={
            'note': 'Used when computing the assembly u-factor, SHGC and visible transmittance for reporting only'
        },
    )
...
class WindowPropertyStormWindow(IDFBaseModel):
    ...
    distance_between_storm_glass_layer_and_adjacent_glass: float | None = Field(
        default=0.05, le=0.5, gt=0.0, json_schema_extra={'units': 'm'}
    )
...
class WindowShadingControl(IDFBaseModel):
    ...
    shading_control_sequence_number: int | None = Field(
        ...
        ge=1,
        json_schema_extra={
            'note': 'If multiple WindowShadingControl objects are used than the order that they deploy the window shades can be set with this field. The first WindowShadingControl should be 1 and subsequent WindowShadi...'
        },
    )
    shading_type: Literal[
        'BetweenGlassBlind',
        'BetweenGlassShade',
        'ExteriorBlind',
        'ExteriorScreen',
    ...
    construction_with_shading_name: ConstructionNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['ConstructionNames'],
            'note': 'Required if Shading Type = SwitchableGlazing Required if Shading Type = interior or exterior shade or blind, or exterior screen, and "Shading Device Material Name" is not specified. If both "Constr...',
        },
    )
    shading_control_type: Literal[
        'AlwaysOff',
        'AlwaysOn',
    ...
    schedule_name: ScheduleNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['ScheduleNames'],
            'note': 'Required if Shading Control Is Scheduled = Yes. If schedule value = 1, shading control is active, i.e., shading can take place only if the control test passes. If schedule value = 0, shading is off...',
        },
    )
    setpoint: float | None = Field(
        ...
        json_schema_extra={
            ...
            'note': 'W/m2 for solar-based controls, W for cooling- or heating-based controls, deg C for temperature-based controls. Unused for Shading Control Type = AlwaysOn, AlwaysOff, OnIfScheduleAllows, OnIfHighGla...',
        },
    )
    shading_control_is_scheduled: Literal['', 'No', 'Yes'] | None = Field(
        default='No',
        json_schema_extra={
    ...
    glare_control_is_active: Literal['', 'No', 'Yes'] | None = Field(
        default='No',
        json_schema_extra={
    ...
    shading_device_material_name: WindowShadesScreensAndBlindsRef | None = Field(
        ...
        json_schema_extra={
            ...
            'note': 'Enter the name of a WindowMaterial:Shade, WindowMaterial:Screen or WindowMaterial:Blind object. Required if "Construction with Shading Name" is not specified. Not used if Shading Control Type = Swi...',
        },
    )
    type_of_slat_angle_control_for_blinds: (
        Literal['', 'BlockBeamSolar', 'FixedSlatAngle', 'ScheduledSlatAngle'] | None
    ) = Field(
    ...
    slat_angle_schedule_name: ScheduleNamesRef | None = Field(
        ...
        json_schema_extra={
            'object_list': ['ScheduleNames'],
            'note': 'Used only if Shading Type = InteriorBlind, ExteriorBlind or BetweenGlassBlind. Required if Type of Slat Angle Control for Blinds = ScheduledSlatAngle Schedule values should be degrees (0 minimum, 1...',
        },
    )
    setpoint_2: float | None = Field(
        default=None,
        json_schema_extra={
    ...
    multiple_surface_control_type: Literal['', 'Group', 'Sequential'] | None = Field(
        default='Sequential',
        json_schema_extra={
            'note': 'When Sequential is used the list of fenestration surfaces are controlled individually in the order specified When Group is used the entire list is controlled simultaneously and if glare control is ...'
        },
    )
    fenestration_surfaces: list[WindowShadingControlFenestrationSurfacesItem] | None = (
        Field(default=None)
    )
...
class Zone(IDFBaseModel):
    ...
    name: str = Field(
        ...,
        json_schema_extra={
            'note': 'Name of the Zone. This name must be unique across Zone, Space, ZoneList, and SpaceList names.'
        },
    )
    direction_of_relative_north: float | None = Field(
        default=0.0, json_schema_extra={'units': 'deg'}
    )
    ...
    ceiling_height: float | Literal['', 'Autocalculate'] | None = Field(
        ...
        json_schema_extra={
            'units': 'm',
            'note': 'If this field is 0.0, negative or autocalculate, then the average height of the zone is automatically calculated and used in subsequent calculations. If this field is positive, then the number ente...',
        },
    )
    volume: float | Literal['', 'Autocalculate'] | None = Field(
        default='Autocalculate',
        json_schema_extra={
            'units': 'm3',
            'note': 'If this field is 0.0, negative or autocalculate, then the volume of the zone is automatically calculated and used in subsequent calculations. If this field is positive, then the number entered here...',
        },
    )
    floor_area: float | Literal['', 'Autocalculate'] | None = Field(
        default='Autocalculate',
        json_schema_extra={
            'units': 'm2',
            'note': 'If this field is 0.0, negative or autocalculate, then the floor area of the zone is automatically calculated and used in subsequent calculations. If this field is positive, then the number entered ...',
        },
    )
    zone_inside_convection_algorithm: (
        ...
        default=None,
        json_schema_extra={
            'note': 'Will default to same value as SurfaceConvectionAlgorithm:Inside object setting this field overrides the default SurfaceConvectionAlgorithm:Inside for this zone Simple = constant natural convection ...'
        },
    )
    zone_outside_convection_algorithm: (
        ...
        default=None,
        json_schema_extra={
            'note': 'Will default to same value as SurfaceConvectionAlgorithm:Outside object setting this field overrides the default SurfaceConvectionAlgorithm:Outside for this zone SimpleCombined = Combined radiation...'
        },
    )
...
class ZoneList(IDFBaseModel):
    ...
    name: str = Field(
        ...,
        json_schema_extra={
            'note': 'Name of the ZoneList. This name must be unique across Zone, Space, ZoneList, and SpaceList names.'
        },
    )
