...
if TYPE_CHECKING:
    ...
    from .constructions import WindowMaterialBlind, WindowMaterialGlazing, WindowMaterialGlazingGroupThermochromic, WindowMaterialGlazingRefractionExtinctionMethod, WindowMaterialScreen, WindowMaterialShade, WindowMaterialSimpleGlazingSystem
...
class WindowShadingControlFenestrationSurfacesItem(IDFBaseModel):
    ...
    @property
    def fenestration_surface(self) -> FenestrationSurfaceDetailed | GlazedDoor | Window | None:
...
tubular daylighting devices)."""
    ...
    def construction(self) -> IDFBaseModel | None:
        ...
        if idf is None:
            raise RuntimeError("Not bound to IDF")
        return idf._resolve_forward(v, ['ComplexFenestrationStates', 'ConstructionNames'])
...
and removed in the summer."""
    ...
    @property
    def storm_glass_layer(self) -> WindowMaterialGlazing | WindowMaterialGlazingGroupThermochromic | WindowMaterialGlazingRefractionExtinctionMethod | WindowMaterialSimpleGlazingSystem | None:
...
and glass doors (ref: FenestrationSurface:Detailed, Window, and GlazedDoor)."""
    ...
    @property
    def shading_device_material(self) -> WindowMaterialBlind | WindowMaterialScreen | WindowMaterialShade | None:
