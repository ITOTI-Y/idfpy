...
class CoolingTowerPerformanceCoolTools(IDFBaseModel):
    ...
    maximum_inlet_air_wet_bulb_temperature: float = Field(
        ...,
        json_schema_extra={
            'units': 'C',
    ...
    minimum_range_temperature: float = Field(
        ...,
        json_schema_extra={
            'units': 'deltaC',
    ...
    maximum_range_temperature: float = Field(
        ...,
        json_schema_extra={
            'units': 'deltaC',
    ...
    minimum_approach_temperature: float = Field(
        ...,
        json_schema_extra={
            'units': 'deltaC',
    ...
    maximum_approach_temperature: float = Field(
        ...,
        json_schema_extra={
            'units': 'deltaC',
    ...
    minimum_water_flow_rate_ratio: float = Field(
        ...,
        json_schema_extra={
            'note': 'Minimum valid water flow rate ratio for this approach temperature correlation.'
        },
    )
    maximum_water_flow_rate_ratio: float = Field(
        ...,
        json_schema_extra={
...
class CoolingTowerPerformanceYorkCalc(IDFBaseModel):
    ...
    maximum_liquid_to_gas_ratio: float = Field(
        ...,
        json_schema_extra={
...
class CoolingTowerSingleSpeed(IDFBaseModel):
    ...
    water_outlet_node_name: str = Field(
        ..., json_schema_extra={'note': 'Name of tower water outlet node'}
    )
    ...
    design_air_flow_rate: float | Literal['Autosize'] = Field(
        ..., json_schema_extra={'units': 'm3/s'}
    )
    design_fan_power: float | Literal['Autosize'] = Field(
        ...,
        json_schema_extra={
            'units': 'W',
    ...
    design_u_factor_times_area_value: float | Literal['Autosize'] | None = Field(
        default=None,
        json_schema_extra={
            'units': 'W/K',
            'note': 'Leave field blank if tower performance input method is NominalCapacity',
    ...
    ) = Field(default=0.0, json_schema_extra={'units': 'm3/s'})
    free_convection_regime_air_flow_rate_sizing_factor: float | None = Field(
        default=0.1,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    free_convection_regime_u_factor_times_area_value: (
        float | Literal['', 'Autocalculate'] | None
    ) = Field(default=0.0, json_schema_extra={'units': 'W/K'})
    free_convection_u_factor_times_area_value_sizing_factor: float | None = Field(
        default=0.1,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    heat_rejection_capacity_and_nominal_capacity_sizing_ratio: float | None = Field(
        default=1.25
    )
    nominal_capacity: float | None = Field(
        ...
        json_schema_extra={
            'units': 'W',
            'note': 'Nominal tower capacity with entering water at 35C (95F), leaving water at 29.44C (85F), entering air at 25.56C (78F) wet-bulb temperature and 35C (95F) dry-bulb temperature. Design water flow rate ...',
        },
    )
    free_convection_capacity: float | Literal['Autocalculate'] | None = Field(
        default=None,
        json_schema_extra={
            'units': 'W',
            'note': 'Tower capacity in free convection regime with entering water at 35C (95F), leaving water at 29.44C (85F), entering air at 25.56C (78F) wet-bulb temperature and 35C (95F) dry-bulb temperature. Desig...',
        },
    )
    free_convection_nominal_capacity_sizing_factor: float | None = Field(
        default=0.1,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    design_inlet_air_dry_bulb_temperature: float | None = Field(
        default=35.0,
        ge=20.0,
        json_schema_extra={
            'units': 'C',
    ...
    design_approach_temperature: float | Literal['', 'Autosize'] | None = Field(
        default='Autosize',
        json_schema_extra={
            'units': 'deltaC',
            'note': 'Enter the approach temperature corresponding to the design inlet air wet-bulb temperature and design range temperature. Design approach temp = outlet water temperature minus inlet air wet-bulb temp...',
        },
    )
    design_range_temperature: float | Literal['', 'Autosize'] | None = Field(
        default='Autosize',
        json_schema_extra={
            'units': 'deltaC',
            'note': 'Enter the range temperature corresponding to the design inlet air wet-bulb temperature and design approach temperature. Design range = inlet water temperature minus outlet water temperature at desi...',
        },
    )
    basin_heater_capacity: float | None = Field(
        ...
        json_schema_extra={
            'units': 'W/K',
            'note': 'This heater maintains the basin water temperature at the basin heater setpoint temperature when the outdoor air temperature falls below the setpoint temperature. The basin heater only operates when...',
        },
    )
    ...
    basin_heater_operating_schedule_name: ScheduleNamesRef | None = Field(
        ...
        json_schema_extra={
            ...
            'note': 'Schedule values greater than 0 allow the basin heater to operate whenever the outdoor air dry-bulb temperature is below the basin heater setpoint temperature. If a schedule name is not entered, the...',
        },
    )
    evaporation_loss_mode: Literal['', 'LossFactor', 'SaturatedExit'] | None = Field(
        default='SaturatedExit'
    )
    evaporation_loss_factor: float | None = Field(
        default=0.2,
        json_schema_extra={
            'units': 'percent/K',
            'note': 'Rate of water evaporation from the cooling tower and lost to the outdoor air [%/K] Evaporation loss is calculated as percentage of the circulating condenser water rate Value entered here is percent...',
        },
    )
    drift_loss_percent: float | None = Field(
        default=0.008,
        json_schema_extra={
            'units': 'percent',
    ...
    blowdown_calculation_mode: (
        Literal['', 'ConcentrationRatio', 'ScheduledRate'] | None
    ) = Field(default='ConcentrationRatio')
    ...
    capacity_control: Literal['', 'FanCycling', 'FluidBypass'] | None = Field(
        default='FanCycling'
    )
    number_of_cells: int | None = Field(default=1, ge=1)
    cell_control: Literal['', 'MaximalCell', 'MinimalCell'] | None = Field(
        default='MaximalCell'
    )
    cell_minimum_water_flow_rate_fraction: float | None = Field(
        default=0.33,
        le=1.0,
        gt=0.0,
        json_schema_extra={
    ...
    cell_maximum_water_flow_rate_fraction: float | None = Field(
        default=2.5,
        ge=1.0,
        json_schema_extra={
...
class CoolingTowerTwoSpeed(IDFBaseModel):
    ...
    high_fan_speed_air_flow_rate: float | Literal['Autosize'] = Field(
        ..., json_schema_extra={'units': 'm3/s'}
    )
    high_fan_speed_fan_power: float | Literal['Autosize'] = Field(
        ...,
        json_schema_extra={
            'units': 'W',
    ...
    high_fan_speed_u_factor_times_area_value: float | Literal['Autosize'] | None = (
        Field(
            default=None,
            json_schema_extra={
                'units': 'W/K',
    ...
    low_fan_speed_air_flow_rate: float | Literal['Autocalculate'] = Field(
        ...,
        json_schema_extra={
            'units': 'm3/s',
    ...
    low_fan_speed_air_flow_rate_sizing_factor: float | None = Field(
        default=0.5,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    low_fan_speed_fan_power: float | Literal['Autocalculate'] = Field(
        ...,
        json_schema_extra={
            'units': 'W',
    ...
    low_fan_speed_fan_power_sizing_factor: float | None = Field(
        default=0.16,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    low_fan_speed_u_factor_times_area_value: float | Literal['Autocalculate'] | None = (
        Field(
            default=None,
            json_schema_extra={
                'units': 'W/K',
    ...
    low_fan_speed_u_factor_times_area_sizing_factor: float | None = Field(
        default=0.6,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    high_speed_nominal_capacity: float | None = Field(
        default=None,
        gt=0.0,
        json_schema_extra={
            'units': 'W',
            'note': 'Nominal tower capacity with entering water at 35C (95F), leaving water at 29.44C (85F), entering air at 25.56C (78F) wet-bulb temperature and 35C (95F) dry-bulb temperature, with the tower fan oper...',
        },
    )
    low_speed_nominal_capacity: float | Literal['Autocalculate'] | None = Field(
        default=None,
        json_schema_extra={
            'units': 'W',
            'note': 'Nominal tower capacity with entering water at 35C (95F), leaving water at 29.44C (85F), entering air at 25.56C (78F) wet-bulb temperature and 35C (95F) dry-bulb temperature, with the tower fan oper...',
    ...
    low_speed_nominal_capacity_sizing_factor: float | None = Field(
        default=0.5,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    free_convection_nominal_capacity: float | Literal['Autocalculate'] | None = Field(
        default=None,
        json_schema_extra={
            'units': 'W',
            'note': 'Tower capacity in free convection regime with entering water at 35C (95F), leaving water at 29.44C (85F), entering air at 25.56C (78F) wet-bulb temperature and 35C (95F) dry-bulb temperature. Desig...',
    ...
    evaporation_loss_factor: float | None = Field(
        ...
        json_schema_extra={
            'units': 'percent/K',
            'note': 'Rate of water evaporated from the cooling tower and lost to the outdoor air [%/K] Evaporation loss is calculated as percentage of the circulating condenser water rate Value entered here is percent-...',
        },
    )
    drift_loss_percent: float | None = Field(
        default=0.008,
...
class CoolingTowerVariableSpeed(IDFBaseModel):
    ...
    design_approach_temperature: float | None = Field(
        default=3.9,
        gt=0.0,
        json_schema_extra={
            'units': 'deltaC',
    ...
    design_range_temperature: float | None = Field(
        default=5.6,
        gt=0.0,
        json_schema_extra={
            'units': 'deltaC',
    ...
    design_water_flow_rate: float | Literal['Autosize'] = Field(
        ...,
        json_schema_extra={
            'units': 'm3/s',
    ...
    minimum_air_flow_rate_ratio: float | None = Field(
        default=0.2,
        ge=0.2,
        le=0.5,
        json_schema_extra={
    ...
    fraction_of_tower_capacity_in_free_convection_regime: float | None = Field(
        default=0.125,
        ge=0.0,
        le=0.2,
        json_schema_extra={
            'note': 'Enter the fraction of tower capacity in the free convection regime. This is the fraction of the tower capacity, at the current inlet air wet-bulb temperature, that is available when the tower fan i...'
        },
    )
    basin_heater_capacity: float | None = Field(
        default=0.0,
...
class CoolingTowerVariableSpeedMerkel(IDFBaseModel):
    ...
    free_convection_nominal_capacity: float | Literal['Autocalculate'] | None = Field(
        ...
        json_schema_extra={
            'units': 'W',
            'note': 'required field when performance method is NominalCapacity Tower capacity in free convection regime with entering water at 35C (95F), leaving water at 29.44C (85F), entering air at 25.56C (78F) wet-...',
        },
    )
    free_convection_nominal_capacity_sizing_factor: float | None = Field(
        default=0.1,
    ...
    design_water_flow_rate_per_unit_of_nominal_capacity: float | None = Field(
        default=5.382e-08,
        json_schema_extra={
            'units': 'm3/s-W',
    ...
    design_air_flow_rate: float | Literal['Autocalculate'] = Field(
        ...,
        json_schema_extra={
            'units': 'm3/s',
    ...
    design_air_flow_rate_per_unit_of_nominal_capacity: float | None = Field(
        default=2.76316e-05,
        json_schema_extra={
            'units': 'm3/s-W',
            'note': 'This field is only used if the previous is set to autocalculate When field is left blank the default scaling factor is adjusted for elevation to increase volume flow at altitude When field has a va...',
        },
    )
    minimum_air_flow_rate_ratio: float | None = Field(
        default=0.2,
    ...
    design_fan_power: float | Literal['Autocalculate'] = Field(
        ...,
        json_schema_extra={
            'units': 'W',
            'note': 'This is the fan motor electric input power at high speed',
    ...
    design_fan_power_per_unit_of_nominal_capacity: float | None = Field(
        default=0.0105,
        json_schema_extra={
            'units': 'dimensionless',
    ...
    fan_power_modifier_function_of_air_flow_rate_ratio_curve_name: UnivariateFunctionsRef = Field(
        ...
        json_schema_extra={
            'object_list': ['UnivariateFunctions'],
            'note': 'Any curve or table with one independent variable can be used cubic curve = a + b*AFR + c*AFR**2 + d*AFR**3 quartic curve = a + b*AFR + c*AFR**2 + d*AFR**3 + e*AFR**4 x = AFR = Ratio of current oper...',
        },
    )
    free_convection_regime_air_flow_rate: (
        float | Literal['', 'Autocalculate'] | None
    ...
    u_factor_times_area_modifier_function_of_water_flow_ratio_curve_name: UnivariateFunctionsRef = Field(
        ...
        json_schema_extra={
            'object_list': ['UnivariateFunctions'],
            'note': 'curve describes how tower UA changes with the flow rate of condenser water through the tower Any curve or table with one independent variable can be used cubic curve = a + b*WFR + c*WFR**2 + d*WFR*...',
        },
    )
    design_inlet_air_dry_bulb_temperature: float | None = Field(
        default=35.0,
...
class EvaporativeFluidCoolerSingleSpeed(IDFBaseModel):
    ...
    water_outlet_node_name: str = Field(
        ..., json_schema_extra={'note': 'Name of Fluid Cooler water outlet node'}
    )
    design_air_flow_rate: float | Literal['Autosize'] = Field(
        ..., json_schema_extra={'units': 'm3/s'}
    )
    design_air_flow_rate_fan_power: float | Literal['Autosize'] = Field(
        ...,
        json_schema_extra={
            'units': 'W',
            'note': 'This is the fan motor electric input power',
    ...
    design_spray_water_flow_rate: float = Field(
        ..., gt=0.0, json_schema_extra={'units': 'm3/s'}
    )
    performance_input_method: Literal[
        ...
        ...,
        json_schema_extra={
            'note': 'User can define fluid cooler thermal performance by specifying the fluid cooler UA and the Design Water Flow Rate, or by specifying the fluid cooler Standard Design Capacity or by specifying Design...'
        },
    )
    outdoor_air_inlet_node_name: str | None = Field(
        default=None,
    ...
    standard_design_capacity: float | None = Field(
        default=None,
        gt=0.0,
        json_schema_extra={
            'units': 'W',
            'note': 'Standard design capacity with entering water at 35C (95F), leaving water at 29.44C (85F), entering air at 25.56C (78F) wet-bulb temperature and 35C (95F) dry-bulb temperature. Design water flow rat...',
        },
    )
    design_air_flow_rate_u_factor_times_area_value: (
        float | Literal['Autosize'] | None
    ...
    user_specified_design_capacity: float | None = Field(
        default=None,
        gt=0.0,
        json_schema_extra={
            'units': 'W',
    ...
    design_entering_air_temperature: float | None = Field(
        ...
        json_schema_extra={
            'units': 'C',
            'note': 'Only used for Performance Input Method = UserSpecifiedDesignCapacity; for other Performance Input Methods, this field is ignored. Design Entering Air Temperature must be greater than Design Enterin...',
        },
    )
    design_entering_air_wet_bulb_temperature: float | None = Field(
        ...
        json_schema_extra={
            'units': 'C',
            'note': 'Only used for Performance Input Method = UserSpecifiedDesignCapacity; for other Performance Input Methods, this field is ignored. Design Entering Air Wet-bulb Temperature must be less than Design E...',
        },
    )
    capacity_control: Literal['', 'FanCycling', 'FluidBypass'] | None = Field(
        default='FanCycling'
...
class EvaporativeFluidCoolerTwoSpeed(IDFBaseModel):
    ...
    high_speed_standard_design_capacity: float | None = Field(
        default=None,
        gt=0.0,
        json_schema_extra={
            'units': 'W',
    ...
    low_speed_standard_design_capacity: float | Literal['Autocalculate'] | None = Field(
        default=None,
        json_schema_extra={
            'units': 'W',
            'note': 'Standard design capacity with entering water at 35C (95F), leaving water at 29.44C (85F), entering air at 25.56C (78F) wet-bulb temperature and 35C (95F) dry-bulb temperature. Design water flow rat...',
    ...
    low_speed_standard_capacity_sizing_factor: float | None = Field(
        default=0.5,
        json_schema_extra={
            'note': 'This field is only used if the previous field is set to autocalculate'
        },
    ...
    high_speed_user_specified_design_capacity: float | None = Field(
        default=None,
        gt=0.0,
        json_schema_extra={
            'units': 'W',
    ...
    low_speed_user_specified_design_capacity_sizing_factor: float | None = Field(
        default=0.5,
        json_schema_extra={
            'note': 'This field is only used if the previous field is set to autocalculate'
        },
    ...
    high_speed_sizing_factor: float | None = Field(
        default=1.0,
        gt=0.0,
        json_schema_extra={'note': 'Multiplies the autosized capacity and flow rates'},
    )
...
class FluidCoolerSingleSpeed(IDFBaseModel):
    ...
    nominal_capacity: float | None = Field(
        default=None,
        gt=0.0,
        json_schema_extra={'units': 'W', 'note': 'Nominal fluid cooler capacity'},
    )
    design_entering_water_temperature: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'C',
    ...
    design_entering_air_temperature: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'C',
    ...
    design_entering_air_wetbulb_temperature: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'C',
...
class FluidCoolerTwoSpeed(IDFBaseModel):
    ...
    low_fan_speed_u_factor_times_area_value: float | Literal['Autocalculate'] | None = (
        Field(
            ...
            json_schema_extra={
                'units': 'W/K',
                'note': 'Leave field blank if fluid cooler Performance Input Method is NominalCapacity Low speed fluid cooler UA must be less than high speed fluid cooler UA Low speed fluid cooler UA must be greater than f...',
            },
        )
    )
    low_fan_speed_u_factor_times_area_sizing_factor: float | None = Field(
    ...
    design_entering_air_wet_bulb_temperature: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'C',
...
class GroundHeatExchangerHorizontalTrench(IDFBaseModel):
    ...
    trench_length_in_pipe_axial_direction: float | None = Field(
        default=50.0,
        gt=0.0,
        json_schema_extra={
            'units': 'm',
            'note': 'This is the total pipe axial length of the heat exchanger If all pipe trenches are parallel, this is the length of a single trench. If a single, long run of pipe is used with one trench, this is th...',
        },
    )
    number_of_trenches: int | None = Field(
        default=1,
        ge=1,
        json_schema_extra={
    ...
    horizontal_spacing_between_pipes: float | None = Field(
        default=1.0,
        gt=0.0,
        json_schema_extra={
            'units': 'm',
    ...
    pipe_inner_diameter: float | None = Field(
        default=0.016, gt=0.0, json_schema_extra={'units': 'm'}
    )
    pipe_outer_diameter: float | None = Field(
    ...
    soil_thermal_conductivity: float | None = Field(
        default=1.08, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    soil_density: float | None = Field(
        default=962.0, gt=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    soil_specific_heat: float | None = Field(
        default=2576.0, gt=0.0, json_schema_extra={'units': 'J/kg-K'}
    )
    pipe_thermal_conductivity: float | None = Field(
        default=0.3895, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    pipe_density: float | None = Field(
        default=641.0, gt=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    pipe_specific_heat: float | None = Field(
        default=2405.0, gt=0.0, json_schema_extra={'units': 'J/kg-K'}
    )
    soil_moisture_content_percent: float | None = Field(
        default=30.0, ge=0.0, le=100.0, json_schema_extra={'units': 'percent'}
    )
    soil_moisture_content_percent_at_saturation: float | None = Field(
...
class GroundHeatExchangerPond(IDFBaseModel):
    ...
    hydronic_tubing_inside_diameter: float = Field(
        ..., gt=0.0, json_schema_extra={'units': 'm'}
    )
    hydronic_tubing_outside_diameter: float = Field(
        ..., gt=0.0, json_schema_extra={'units': 'm'}
    )
    hydronic_tubing_thermal_conductivity: float = Field(
        ..., gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    ground_thermal_conductivity: float = Field(
        ..., gt=0.0, json_schema_extra={'units': 'W/m2-K'}
    )
    number_of_tubing_circuits: int = Field(..., ge=1)
    length_of_each_tubing_circuit: float = Field(
...
class GroundHeatExchangerResponseFactors(IDFBaseModel):
    ...
    g_function_reference_ratio: float | None = Field(
        default=0.0005, gt=0.0, json_schema_extra={'units': 'dimensionless'}
    )
...
class GroundHeatExchangerSlinky(IDFBaseModel):
    ...
    inlet_node_name: str = Field(...)
    outlet_node_name: str = Field(...)
    design_flow_rate: float | None = Field(
        default=0.002, gt=0.0, json_schema_extra={'units': 'm3/s'}
    )
    soil_thermal_conductivity: float | None = Field(
        default=1.08, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    ...
    pipe_thermal_conductivity: float | None = Field(
        default=0.4, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    pipe_density: float | None = Field(
        default=641.0, gt=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    ...
    pipe_outer_diameter: float | None = Field(
        default=0.02667, gt=0.0, json_schema_extra={'units': 'm'}
    )
    pipe_thickness: float | None = Field(
        default=0.002413, gt=0.0, json_schema_extra={'units': 'm'}
    )
    heat_exchanger_configuration: Literal['Horizontal', 'Vertical'] | None = Field(
        default=None,
        json_schema_extra={'note': 'This is the orientation of the heat exchanger'},
    )
    coil_diameter: float | None = Field(
        default=1.0,
        gt=0.0,
        json_schema_extra={
            'units': 'm',
    ...
    trench_length: float | None = Field(
        default=10.0,
        gt=0.0,
        json_schema_extra={
            'units': 'm',
...
class GroundHeatExchangerSurface(IDFBaseModel):
    ...
    fluid_inlet_node_name: str = Field(...)
    fluid_outlet_node_name: str = Field(...)
    hydronic_tubing_inside_diameter: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'm'}
    )
    number_of_tubing_circuits: int | None = Field(default=None, ge=1)
    hydronic_tube_spacing: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'm'}
    )
    surface_length: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'm'}
    )
    surface_width: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'm'}
    )
...
class GroundHeatExchangerVerticalProperties(IDFBaseModel):
    ...
    grout_thermal_conductivity: float = Field(
        ..., gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    grout_thermal_heat_capacity: float = Field(
        ..., gt=0.0, json_schema_extra={'units': 'J/m3-K'}
    )
    pipe_thermal_conductivity: float = Field(
        ..., gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    pipe_thermal_heat_capacity: float = Field(
        ..., gt=0.0, json_schema_extra={'units': 'J/m3-K'}
    )
...
class HeatExchangerFluidToFluid(IDFBaseModel):
    ...
    loop_demand_side_inlet_node_name: str = Field(
        ...,
        json_schema_extra={
            'note': 'This connection is to the demand side of a loop and is the inlet to the heat exchanger'
        },
    )
    loop_demand_side_outlet_node_name: str = Field(
        ...,
        json_schema_extra={'note': 'This connection is to the demand side of a loop'},
    )
    loop_demand_side_design_flow_rate: float | Literal['Autosize'] = Field(
        ..., json_schema_extra={'units': 'm3/s'}
    )
    loop_supply_side_inlet_node_name: str = Field(...)
    loop_supply_side_outlet_node_name: str = Field(...)
    loop_supply_side_design_flow_rate: float | Literal['Autosize'] = Field(
        ..., json_schema_extra={'units': 'm3/s'}
    )
    ...
    heat_exchanger_u_factor_times_area_value: float | Literal['Autosize'] = Field(
    ...
    control_type: (
        ...
        | None
    ) = Field(default='UncontrolledOn')
    heat_exchanger_setpoint_node_name: str | None = Field(
        default=None,
        json_schema_extra={
            'note': 'Setpoint node is needed with any Control Type that is "*Setpoint*"'
        },
    )
    minimum_temperature_difference_to_activate_heat_exchanger: float | None = Field(
        default=0.01,
        ge=0.0,
        le=50.0,
        json_schema_extra={
    ...
    component_override_loop_supply_side_inlet_node_name: str | None = Field(
        default=None,
        json_schema_extra={
            'note': 'This field is only used if Control Type is set to CoolingSetpointOnOffWithComponentOverride'
        },
    )
    component_override_loop_demand_side_inlet_node_name: str | None = Field(
        default=None,
        json_schema_extra={
            'note': 'This field is only used if Control Type is set to CoolingSetpointOnOffWithComponentOverride'
        },
    ...
    component_override_cooling_control_temperature_mode: (
        Literal['', 'DryBulbTemperature', 'Loop', 'WetBulbTemperature'] | None
    ) = Field(
        default='Loop',
        json_schema_extra={
            'note': 'This field is only used if Control Type is set to CoolingSetpointOnOffWithComponentOverride'
    ...
    operation_minimum_temperature_limit: float | None = Field(
        default=None,
        json_schema_extra={
            'units': 'C',
    ...
    operation_maximum_temperature_limit: float | None = Field(
        default=None,
        json_schema_extra={
            'units': 'C',
