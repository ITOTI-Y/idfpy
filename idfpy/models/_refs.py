...
AirflowNetworkDistributionLinkageNamesRef = Annotated[str, BeforeValidator(RefValidator("AirflowNetworkDistributionLinkageNames"))]
...
GroundHeatExchangerVerticalSizingNamesRef = Annotated[str, BeforeValidator(RefValidator("GroundHeatExchangerVerticalSizingNames"))]
...
SizingPeriodWeatherFileDaysRef = Annotated[str, BeforeValidator(RefValidator("SizingPeriodWeatherFileDays"))]
...
ThermalStorageSizingRef = Annotated[str, BeforeValidator(RefValidator("ThermalStorageSizing"))]
ThermalStorageWaterNamesRef = Annotated[str, BeforeValidator(RefValidator("ThermalStorageWaterNames"))]
