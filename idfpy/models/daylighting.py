...
if TYPE_CHECKING:
    from .thermal_zones import ShadingFin, ShadingFinProjection, ShadingOverhang, ShadingOverhangProjection, ShadingZoneDetailed, Space, Zone
...
point. Glare from daylighting is also calculated."""
    ...
    @property
    def glare_calculation_daylighting_reference_point(self) -> DaylightingReferencePoint | None:
...
shelf is defined as a shading surface."""
    ...
    @property
    def outside_shelf(self) -> ShadingFin | ShadingFinProjection | ShadingOverhang | ShadingOverhangProjection | ShadingZoneDetailed | None:
