...
class MaterialPropertyPhaseChangeValuesItem(IDFBaseModel):
    ...
    temperature: float = Field(
        ...,
        json_schema_extra={'units': 'C', 'note': 'for Temperature-enthalpy function'},
    )
...
class ConstructionAirBoundary(IDFBaseModel):
    ...
    _provider_fields: ClassVar[frozenset[str]] = frozenset({'name'})
    name: str = Field(...)
    air_exchange_method: Literal['', 'None', 'SimpleMixing'] | None = Field(
        default='None',
        json_schema_extra={
            'note': 'This field controls how air exchange is modeled across this boundary.'
        },
    )
    simple_mixing_air_changes_per_hour: float | None = Field(
        default=0.5,
        ge=0.0,
        json_schema_extra={
            'units': '1/hr',
...
class ConstructionComplexFenestrationState(IDFBaseModel):
    ...
    _provider_fields: ClassVar[frozenset[str]] = frozenset({'name'})
    name: str = Field(...)
    basis_type: Literal['', 'LBNLWINDOW', 'UserDefined'] | None = Field(
        default='LBNLWINDOW'
    )
...
class ConstructionFfactorGroundFloor(IDFBaseModel):
    ...
    area: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={'units': 'm2', 'note': 'Enter area of the floor'},
    )
    perimeterexposed: float = Field(
        ...,
        ge=0.0,
        json_schema_extra={
            'units': 'm',
...
class ConstructionPropertyInternalHeatSource(IDFBaseModel):
    ...
    thermal_source_present_after_layer_number: int = Field(
        ...,
        ge=1,
        json_schema_extra={'note': 'refers to the list of materials which follows'},
    )
    temperature_calculation_requested_after_layer_number: int = Field(
        ..., json_schema_extra={'note': 'refers to the list of materials which follows'}
    )
    dimensions_for_the_ctf_calculation: int = Field(
        ...,
        ge=1,
        le=2,
        json_schema_extra={
    ...
    two_dimensional_temperature_calculation_position: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={
            'units': 'dimensionless',
            'note': 'used in conjunction with field Temperature Calculation Requested After Layer Number this field is the location perpendicular to the main direction of heat transfer 0.0 means in line with the tubing...',
        },
    )
...
class MaterialAirGap(IDFBaseModel):
    ...
    thermal_resistance: float = Field(
        ..., gt=0.0, json_schema_extra={'units': 'm2-K/W'}
    )
...
class MaterialNoMass(IDFBaseModel):
    ...
    thermal_resistance: float = Field(
        ..., ge=0.001, json_schema_extra={'units': 'm2-K/W'}
    )
    thermal_absorptance: float | None = Field(default=0.9, le=0.99999, gt=0.0)
    solar_absorptance: float | None = Field(default=0.7, ge=0.0, le=1.0)
    visible_absorptance: float | None = Field(default=0.7, ge=0.0, le=1.0)
...
class MaterialPropertyGlazingSpectralData(IDFBaseModel):
    ...
    extensions: list[MaterialPropertyGlazingSpectralDataExtensionsItem] | None = Field(
        default=None
    )
...
class MaterialPropertyHeatAndMoistureTransferDiffusion(IDFBaseModel):
    ...
    number_of_data_pairs: int = Field(
        ...,
        ge=1,
        le=25,
        json_schema_extra={'note': 'Water Vapor Diffusion Resistance Factor'},
    )
    relative_humidity_fraction_1: float = Field(
        ...,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_1: float = Field(
        ..., ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_2: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_2: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_3: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_3: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_4: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_4: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_5: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_5: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_6: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_6: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_7: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_7: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_8: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_8: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_9: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_9: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_10: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_10: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_11: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_11: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_12: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_12: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_13: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_13: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_14: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_14: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_15: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_15: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_16: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_16: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_17: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_17: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_18: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_18: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_19: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_19: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_20: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_20: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_21: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_21: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_22: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_22: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_23: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_23: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_24: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_24: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
    relative_humidity_fraction_25: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    water_vapor_diffusion_resistance_factor_25: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'dimensionless'}
    )
...
class MaterialPropertyHeatAndMoistureTransferRedistribution(IDFBaseModel):
    ...
    number_of_redistribution_points: int = Field(
        ..., ge=1, le=25, json_schema_extra={'note': 'number of data points'}
    )
    moisture_content_1: float = Field(..., ge=0.0, json_schema_extra={'units': 'kg/m3'})
    liquid_transport_coefficient_1: float = Field(
        ..., ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_2: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_2: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_3: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_3: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_4: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_4: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_5: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_5: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_6: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_6: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_7: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_7: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_8: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_8: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_9: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_9: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_10: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_10: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_11: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_11: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_12: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_12: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_13: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_13: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_14: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_14: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_15: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_15: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_16: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_16: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_17: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_17: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_18: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_18: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_19: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_19: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_20: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_20: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_21: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_21: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_22: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_22: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_23: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_23: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_24: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_24: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
    moisture_content_25: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    liquid_transport_coefficient_25: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'm2/s'}
    )
...
class MaterialPropertyHeatAndMoistureTransferSettings(IDFBaseModel):
    ...
    initial_water_content_ratio: float | None = Field(
        default=0.2,
        ge=0.0,
        json_schema_extra={
            'units': 'kg/kg',
...
class MaterialPropertyHeatAndMoistureTransferSorptionIsotherm(IDFBaseModel):
    ...
    number_of_isotherm_coordinates: int = Field(
        ..., ge=1, le=25, json_schema_extra={'note': 'Number of data Coordinates'}
    )
    relative_humidity_fraction_1: float = Field(
        ...,
        ge=0.0,
...
class MaterialPropertyHeatAndMoistureTransferSuction(IDFBaseModel):
    ...
    number_of_suction_points: int = Field(
        ...,
        ge=1,
        le=25,
        json_schema_extra={
...
class MaterialPropertyHeatAndMoistureTransferThermalConductivity(IDFBaseModel):
    ...
    number_of_thermal_coordinates: int = Field(
        ..., ge=1, le=25, json_schema_extra={'note': 'number of data coordinates'}
    )
    moisture_content_1: float = Field(..., ge=0.0, json_schema_extra={'units': 'kg/m3'})
    thermal_conductivity_1: float = Field(
        ..., gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_2: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_2: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_3: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_3: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_4: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_4: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_5: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_5: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_6: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_6: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_7: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_7: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_8: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_8: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_9: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_9: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_10: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_10: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_11: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_11: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_12: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_12: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_13: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_13: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_14: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_14: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_15: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_15: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_16: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_16: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_17: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_17: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_18: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_18: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_19: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_19: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_20: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_20: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_21: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_21: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_22: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_22: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_23: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_23: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_24: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_24: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    moisture_content_25: float | None = Field(
        default=None, ge=0.0, json_schema_extra={'units': 'kg/m3'}
    )
    thermal_conductivity_25: float | None = Field(
        default=None, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
...
class MaterialPropertyMoisturePenetrationDepthSettings(IDFBaseModel):
    ...
    water_vapor_diffusion_resistance_factor: float = Field(
        ...,
        ge=0.0,
        json_schema_extra={
            'units': 'dimensionless',
    ...
    moisture_equation_coefficient_a: float = Field(
        ..., json_schema_extra={'units': 'dimensionless'}
    )
    moisture_equation_coefficient_b: float = Field(
        ..., json_schema_extra={'units': 'dimensionless'}
    )
    moisture_equation_coefficient_c: float = Field(
        ..., json_schema_extra={'units': 'dimensionless'}
    )
    moisture_equation_coefficient_d: float = Field(
        ..., json_schema_extra={'units': 'dimensionless'}
    )
    surface_layer_penetration_depth: float | Literal['', 'Autocalculate'] | None = (
        Field(default='Autocalculate', json_schema_extra={'units': 'm'})
    )
    deep_layer_penetration_depth: float | Literal['', 'Autocalculate'] | None = Field(
        default='Autocalculate', json_schema_extra={'units': 'm'}
    )
    coating_layer_thickness: float = Field(
        ..., ge=0.0, json_schema_extra={'units': 'm'}
    )
    coating_layer_water_vapor_diffusion_resistance_factor: float = Field(
        ...,
        ge=0.0,
        json_schema_extra={
            'units': 'dimensionless',
...
class MaterialPropertyPhaseChange(IDFBaseModel):
    ...
    temperature_coefficient_for_thermal_conductivity: float | None = Field(
        default=0.0,
        json_schema_extra={
            'units': 'W/m-K2',
            'note': 'The base temperature is 20C. This is the thermal conductivity change per degree excursion from 20C. This variable conductivity function is overridden by the VariableThermalConductivity object, if p...',
        },
    )
...
class MaterialPropertyPhaseChangeHysteresis(IDFBaseModel):
    ...
    latent_heat_during_the_entire_phase_change_process: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'J/kg',
    ...
    liquid_state_thermal_conductivity: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'W/m-K',
    ...
    liquid_state_density: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'kg/m3',
    ...
    liquid_state_specific_heat: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'J/kg-K',
    ...
    high_temperature_difference_of_melting_curve: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'deltaC',
    ...
    low_temperature_difference_of_melting_curve: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'deltaC',
    ...
    solid_state_thermal_conductivity: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'W/m-K',
    ...
    solid_state_density: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'kg/m3',
    ...
    solid_state_specific_heat: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'J/kg-K',
    ...
    high_temperature_difference_of_freezing_curve: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'deltaC',
    ...
    low_temperature_difference_of_freezing_curve: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'deltaC',
...
class MaterialRoofVegetation(IDFBaseModel):
    ...
    _provider_fields: ClassVar[frozenset[str]] = frozenset({'name'})
    name: str = Field(...)
    height_of_plants: float | None = Field(
        default=0.2,
        le=1.0,
        gt=0.005,
        json_schema_extra={
    ...
    leaf_reflectivity: float | None = Field(
        default=0.22,
        ge=0.05,
        le=0.5,
        json_schema_extra={
    ...
    minimum_stomatal_resistance: float | None = Field(
        default=180.0,
        ge=50.0,
        le=300.0,
        json_schema_extra={'units': 's/m', 'note': 'This depends upon plant type'},
    )
    ...
    conductivity_of_dry_soil: float | None = Field(
        default=0.35,
        ge=0.2,
        le=1.5,
        json_schema_extra={
    ...
    density_of_dry_soil: float | None = Field(
        default=1100.0,
        ge=300.0,
        le=2000.0,
        json_schema_extra={
    ...
    specific_heat_of_dry_soil: float | None = Field(
        default=1200.0,
        le=2000.0,
        gt=500.0,
        json_schema_extra={'units': 'J/kg-K', 'note': 'Specific heat of dry soil'},
    )
    ...
    saturation_volumetric_moisture_content_of_the_soil_layer: float | None = Field(
        default=0.3,
        le=0.5,
        gt=0.1,
        json_schema_extra={
    ...
    residual_volumetric_moisture_content_of_the_soil_layer: float | None = Field(
        default=0.01, ge=0.01, le=0.1
    )
    initial_volumetric_moisture_content_of_the_soil_layer: float | None = Field(
        default=0.1, le=0.5, gt=0.05
    )
    moisture_diffusion_calculation_method: Literal['', 'Advanced', 'Simple'] | None = (
        Field(
            default='Advanced',
            json_schema_extra={
...
class WindowGapDeflectionState(IDFBaseModel):
    ...
    _provider_fields: ClassVar[frozenset[str]] = frozenset({'name'})
    name: str = Field(...)
    deflected_thickness: float | None = Field(
        default=0.0,
        ge=0.0,
        json_schema_extra={
            'units': 'm',
    ...
    initial_temperature: float | None = Field(
        default=25.0, ge=0.0, json_schema_extra={'units': 'C'}
    )
    initial_pressure: float | None = Field(
        default=101325.0, ge=0.0, json_schema_extra={'units': 'Pa'}
    )
...
class WindowGapSupportPillar(IDFBaseModel):
    ...
    spacing: float | None = Field(
        default=0.04, gt=0.0, json_schema_extra={'units': 'm'}
    )
    radius: float | None = Field(
        default=0.0004, gt=0.0, json_schema_extra={'units': 'm'}
    )
...
class WindowMaterialBlind(IDFBaseModel):
    ...
    _provider_fields: ClassVar[frozenset[str]] = frozenset({'name'})
    name: str = Field(...)
    slat_orientation: Literal['', 'Horizontal', 'Vertical'] | None = Field(
        default='Horizontal'
    )
    ...
    slat_thickness: float | None = Field(
        default=0.00025,
        le=0.1,
        gt=0.0,
        json_schema_extra={
    ...
    slat_angle: float | None = Field(
        default=45.0,
        ge=0.0,
        le=180.0,
        json_schema_extra={
            'units': 'deg',
            'note': 'If WindowShadingControl referencing the window that incorporates this blind has Type of Slat Angle Control for Blinds = FixedSlatAngle, then this is the fixed value of the slat angle; If WindowShad...',
        },
    )
    slat_conductivity: float | None = Field(
        default=221.0,
        gt=0.0,
        json_schema_extra={'units': 'W/m-K', 'note': 'default is for aluminum'},
    )
    ...
    slat_diffuse_solar_transmittance: float | None = Field(
        default=0.0,
        ge=0.0,
        lt=1.0,
        json_schema_extra={'note': 'Must equal "Slat beam solar transmittance"'},
    )
    front_side_slat_diffuse_solar_reflectance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_slat_diffuse_solar_reflectance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    slat_beam_visible_transmittance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={'note': 'Required for detailed daylighting calculation'},
    )
    front_side_slat_beam_visible_reflectance: float | None = Field(
        default=None,
        ge=0.0,
        lt=1.0,
        json_schema_extra={'note': 'Required for detailed daylighting calculation'},
    )
    back_side_slat_beam_visible_reflectance: float | None = Field(
        default=None,
        ge=0.0,
        lt=1.0,
        json_schema_extra={'note': 'Required for detailed daylighting calculation'},
    )
    slat_diffuse_visible_transmittance: float | None = Field(
        default=0.0,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    front_side_slat_diffuse_visible_reflectance: float | None = Field(
        default=None,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_slat_diffuse_visible_reflectance: float | None = Field(
        default=None,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    slat_infrared_hemispherical_transmittance: float | None = Field(
        default=0.0, ge=0.0, lt=1.0
    )
    front_side_slat_infrared_hemispherical_emissivity: float | None = Field(
        default=0.9, ge=0.0, lt=1.0
    )
    back_side_slat_infrared_hemispherical_emissivity: float | None = Field(
        default=0.9, ge=0.0, lt=1.0
    )
    blind_to_glass_distance: float | None = Field(
        default=0.05, ge=0.01, le=1.0, json_schema_extra={'units': 'm'}
    )
    ...
    blind_left_side_opening_multiplier: float | None = Field(
        default=0.5, ge=0.0, le=1.0
    )
    blind_right_side_opening_multiplier: float | None = Field(
        default=0.5, ge=0.0, le=1.0
    )
    minimum_slat_angle: float | None = Field(
        default=0.0,
        ge=0.0,
        le=180.0,
        json_schema_extra={
            'units': 'deg',
            'note': 'Used only if WindowShadingControl referencing the window that incorporates this blind varies the slat angle (i.e., WindowShadingControl with Type of Slat Angle Control for Blinds = ScheduledSlatAng...',
        },
    )
    maximum_slat_angle: float | None = Field(
        default=180.0,
        ge=0.0,
        le=180.0,
        json_schema_extra={
...
class WindowMaterialBlindEquivalentLayer(IDFBaseModel):
    ...
    slat_angle: float | None = Field(
        ...
        json_schema_extra={
            'units': 'deg',
            'note': 'Slat angle is +ve if the tip of the slat front face is tilted upward, else the slat angle is -ve if the tip of the slat front face is tilted downward. The slat angle varies between -90 to +90. The ...',
        },
    )
    front_side_slat_beam_diffuse_solar_transmittance: float | None = Field(
        default=0.0,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_slat_beam_diffuse_solar_transmittance: float | None = Field(
        default=0.0,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    front_side_slat_beam_diffuse_solar_reflectance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_slat_beam_diffuse_solar_reflectance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    front_side_slat_beam_diffuse_visible_transmittance: float | None = Field(
        default=0.0,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_slat_beam_diffuse_visible_transmittance: float | None = Field(
        default=0.0,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    front_side_slat_beam_diffuse_visible_reflectance: float | None = Field(
        default=None,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_slat_beam_diffuse_visible_reflectance: float | None = Field(
        default=None,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    slat_diffuse_diffuse_solar_transmittance: float | None = Field(
        default=0.0,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    front_side_slat_diffuse_diffuse_solar_reflectance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_slat_diffuse_diffuse_solar_reflectance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    slat_diffuse_diffuse_visible_transmittance: float | None = Field(
        default=None,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    front_side_slat_diffuse_diffuse_visible_reflectance: float | None = Field(
        default=None,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_slat_diffuse_diffuse_visible_reflectance: float | None = Field(
        default=None,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    slat_infrared_transmittance: float | None = Field(
        default=0.0,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    front_side_slat_infrared_emissivity: float | None = Field(
        default=0.9,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_slat_infrared_emissivity: float | None = Field(
        default=0.9,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    slat_angle_control: (
        Literal['', 'BlockBeamSolar', 'FixedSlatAngle', 'MaximizeSolar'] | None
    ) = Field(
        default='FixedSlatAngle',
        json_schema_extra={
            'note': 'Used only if slat angle control is desired to either maximize solar gain (MaximizeSolar), maximize visibility while eliminating beam solar radiation (BlockBeamSolar), or fixed slate angle (FixedSla...'
        },
    )
...
class WindowMaterialComplexShade(IDFBaseModel):
    ...
    layer_type: (
        ...
        | None
    ) = Field(default='OtherShadingType')
    thickness: float | None = Field(
        default=0.002, gt=0.0, json_schema_extra={'units': 'm'}
    )
    conductivity: float | None = Field(
        default=1.0, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    ...
    slat_width: float | None = Field(
        default=0.016, gt=0.0, json_schema_extra={'units': 'm'}
    )
    slat_spacing: float | None = Field(
        default=0.012,
        gt=0.0,
        json_schema_extra={
            'units': 'm',
    ...
    slat_angle: float | None = Field(
        default=90.0, ge=-90.0, le=90.0, json_schema_extra={'units': 'deg'}
    )
    slat_conductivity: float | None = Field(
        default=160.0, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    slat_curve: float | None = Field(
        default=0.0,
        ge=0.0,
        json_schema_extra={
            'units': 'm',
...
class WindowMaterialDrapeEquivalentLayer(IDFBaseModel):
    ...
    _provider_fields: ClassVar[frozenset[str]] = frozenset({'name'})
    name: str = Field(...)
    drape_beam_beam_solar_transmittance_at_normal_incidence: float | None = Field(
        default=0.0,
        ge=0.0,
        le=0.2,
        json_schema_extra={
    ...
    front_side_drape_beam_diffuse_solar_transmittance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_drape_beam_diffuse_solar_transmittance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    front_side_drape_beam_diffuse_solar_reflectance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_drape_beam_diffuse_solar_reflectance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    drape_beam_beam_visible_transmittance: float | None = Field(
        default=None,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    drape_beam_diffuse_visible_transmittance: float | None = Field(
        default=None,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    drape_beam_diffuse_visible_reflectance: float | None = Field(
        default=None,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    drape_material_infrared_transmittance: float | None = Field(
        default=0.05,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    front_side_drape_material_infrared_emissivity: float | None = Field(
        default=0.87,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_drape_material_infrared_emissivity: float | None = Field(
        default=0.87,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    width_of_pleated_fabric: float | None = Field(
        default=0.0,
        ge=0.0,
        json_schema_extra={
            'units': 'm',
    ...
    length_of_pleated_fabric: float | None = Field(
        default=0.0,
        ge=0.0,
        json_schema_extra={
            'units': 'm',
...
class WindowMaterialGap(IDFBaseModel):
    ...
    gas_or_gas_mixture: WindowGasAndGasMixturesRef = Field(
        ...,
        validation_alias='gas_or_gas_mixture_',
        json_schema_extra={
...
class WindowMaterialGapEquivalentLayer(IDFBaseModel):
    ...
    thickness: float = Field(..., gt=0.0, json_schema_extra={'units': 'm'})
    gap_vent_type: Literal['Sealed', 'VentedIndoor', 'VentedOutdoor'] = Field(
        ...,
        json_schema_extra={
            'note': 'Sealed means the gap is enclosed and gas tight, i.e., no venting to indoor or outdoor environment. VentedIndoor means the gap is vented to indoor environment, and VentedOutdoor means the gap is ven...'
        },
    )
    conductivity_coefficient_a: float | None = Field(
        default=None,
        json_schema_extra={'units': 'W/m-K', 'note': 'Used only if Gas Type = Custom'},
    )
    conductivity_coefficient_b: float | None = Field(
        default=None,
        json_schema_extra={'units': 'W/m-K2', 'note': 'Used only if Gas Type = Custom'},
    )
    conductivity_coefficient_c: float | None = Field(
        default=None,
        json_schema_extra={'units': 'W/m-K3', 'note': 'Used only if Gas Type = Custom'},
    )
    viscosity_coefficient_a: float | None = Field(
        default=None,
        gt=0.0,
        json_schema_extra={'units': 'kg/m-s', 'note': 'Used only if Gas Type = Custom'},
    )
    viscosity_coefficient_b: float | None = Field(
        default=None,
        json_schema_extra={
            'units': 'kg/m-s-K',
    ...
    viscosity_coefficient_c: float | None = Field(
        default=None,
        json_schema_extra={
            'units': 'kg/m-s-K2',
            'note': 'Used only if Gas Type = Custom',
    ...
    specific_heat_coefficient_a: float | None = Field(
        default=None,
        gt=0.0,
        json_schema_extra={'units': 'J/kg-K', 'note': 'Used only if Gas Type = Custom'},
    )
    specific_heat_coefficient_b: float | None = Field(
        default=None,
        json_schema_extra={
            'units': 'J/kg-K2',
            'note': 'Used only if Gas Type = Custom',
    ...
    specific_heat_coefficient_c: float | None = Field(
        default=None,
        json_schema_extra={
            'units': 'J/kg-K3',
            'note': 'Used only if Gas Type = Custom',
    ...
    molecular_weight: float | None = Field(
        ...
        ge=20.0,
        le=200.0,
        json_schema_extra={'units': 'g/mol', 'note': 'Used only if Gas Type = Custom'},
    )
    specific_heat_ratio: float | None = Field(
        default=None,
        gt=1.0,
        json_schema_extra={'note': 'Used only if Gas Type = Custom'},
    )
...
class WindowMaterialGlazing(IDFBaseModel):
    ...
    thickness: float = Field(..., gt=0.0, json_schema_extra={'units': 'm'})
    solar_transmittance_at_normal_incidence: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    front_side_solar_reflectance_at_normal_incidence: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    back_side_solar_reflectance_at_normal_incidence: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    visible_transmittance_at_normal_incidence: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    front_side_visible_reflectance_at_normal_incidence: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    back_side_visible_reflectance_at_normal_incidence: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    infrared_transmittance_at_normal_incidence: float | None = Field(
        default=0.0, ge=0.0, le=1.0
    )
    front_side_infrared_hemispherical_emissivity: float | None = Field(
        default=0.84, gt=0.0, lt=1.0
    )
    back_side_infrared_hemispherical_emissivity: float | None = Field(
        default=0.84, gt=0.0, lt=1.0
    )
    conductivity: float | None = Field(
        default=0.9, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
    dirt_correction_factor_for_solar_and_visible_transmittance: float | None = Field(
        default=1.0, le=1.0, gt=0.0
    )
    solar_diffusing: Literal['', 'No', 'Yes'] | None = Field(default='No')
    young_s_modulus: float | None = Field(
    ...
    poisson_s_ratio: float | None = Field(
        default=0.22,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
...
class WindowMaterialGlazingEquivalentLayer(IDFBaseModel):
    ...
    _provider_fields: ClassVar[frozenset[str]] = frozenset({'name'})
    name: str = Field(...)
    optical_data_type: Literal['', 'Spectral', 'SpectralAverage'] | None = Field(
    ...
    front_side_beam_beam_solar_transmittance: float = Field(
        ...,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    back_side_beam_beam_solar_transmittance: float = Field(
        ...,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    front_side_beam_beam_solar_reflectance: float = Field(
        ...,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    back_side_beam_beam_solar_reflectance: float = Field(
        ...,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    front_side_beam_beam_visible_solar_transmittance: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    back_side_beam_beam_visible_solar_transmittance: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    front_side_beam_beam_visible_solar_reflectance: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    back_side_beam_beam_visible_solar_reflectance: float | None = Field(
        default=None,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    front_side_beam_diffuse_solar_transmittance: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    back_side_beam_diffuse_solar_transmittance: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    front_side_beam_diffuse_solar_reflectance: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    back_side_beam_diffuse_solar_reflectance: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    front_side_beam_diffuse_visible_solar_transmittance: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    back_side_beam_diffuse_visible_solar_transmittance: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    front_side_beam_diffuse_visible_solar_reflectance: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    back_side_beam_diffuse_visible_solar_reflectance: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    diffuse_diffuse_solar_transmittance: float | Literal['', 'Autocalculate'] | None = (
        Field(
            default='Autocalculate',
            json_schema_extra={
                'units': 'dimensionless',
                'note': 'Used only when Optical Data Type = SpectralAverage If this field is autocalculate, then the diffuse-diffuse solar transmittance is automatically estimated from other inputs and used in subsequent c...',
            },
        )
    )
    front_side_diffuse_diffuse_solar_reflectance: (
        ...
        json_schema_extra={
            'units': 'dimensionless',
            'note': 'Used only when Optical Data Type = SpectralAverage If this field is autocalculate, then the front diffuse-diffuse solar reflectance is automatically estimated from other inputs and used in subseque...',
        },
    )
    back_side_diffuse_diffuse_solar_reflectance: (
        ...
        json_schema_extra={
            'units': 'dimensionless',
            'note': 'Used only when Optical Data Type = SpectralAverage If this field is autocalculate, then the back diffuse-diffuse solar reflectance is automatically estimated from other inputs and used in subsequen...',
        },
    )
    ...
    infrared_transmittance_applies_to_front_and_back: float | None = Field(
        default=0.0,
        validation_alias='infrared_transmittance_applies_to_front_and_back_',
        ge=0.0,
        le=1.0,
        json_schema_extra={
            'units': 'dimensionless',
    ...
    front_side_infrared_emissivity: float | None = Field(
        default=0.84,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_infrared_emissivity: float | None = Field(
        default=0.84,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
...
class WindowMaterialGlazingGroupThermochromic(IDFBaseModel):
    ...
    name: str = Field(...)
    temperature_data: (
        list[WindowMaterialGlazingGroupThermochromicTemperatureDataItem] | None
    ) = Field(default=None)
...
class WindowMaterialGlazingRefractionExtinctionMethod(IDFBaseModel):
    ...
    solar_extinction_coefficient: float = Field(
        ..., gt=0.0, json_schema_extra={'units': '1/m'}
    )
    visible_index_of_refraction: float = Field(..., gt=1.0)
    visible_extinction_coefficient: float = Field(
        ..., gt=0.0, json_schema_extra={'units': '1/m'}
    )
    infrared_transmittance_at_normal_incidence: float | None = Field(
        default=0.0, ge=0.0, lt=1.0
    )
    infrared_hemispherical_emissivity: float | None = Field(
        default=0.84,
        gt=0.0,
        lt=1.0,
        json_schema_extra={'note': 'Emissivity of front and back side assumed equal'},
    )
    conductivity: float | None = Field(
        default=0.9, gt=0.0, json_schema_extra={'units': 'W/m-K'}
    )
...
class WindowMaterialScreen(IDFBaseModel):
    ...
    reflected_beam_transmittance_accounting_method: (
        Literal['', 'DoNotModel', 'ModelAsDiffuse', 'ModelAsDirectBeam'] | None
    ) = Field(
    ...
    thermal_hemispherical_emissivity: float | None = Field(
        default=0.9,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    screen_material_spacing: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'm',
    ...
    screen_material_diameter: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
            'units': 'm',
    ...
    screen_to_glass_distance: float | None = Field(
        default=0.025,
        ge=0.001,
        le=1.0,
        json_schema_extra={
    ...
    top_opening_multiplier: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    bottom_opening_multiplier: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    left_side_opening_multiplier: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={
    ...
    right_side_opening_multiplier: float | None = Field(
        default=0.0,
        ge=0.0,
        le=1.0,
        json_schema_extra={
...
class WindowMaterialScreenEquivalentLayer(IDFBaseModel):
    ...
    screen_beam_beam_solar_transmittance: (
        ...
        json_schema_extra={
            'units': 'dimensionless',
            'note': 'The beam-beam transmittance of the screen material at normal incidence. This input field is the same as the material openness area fraction and can be autocalculated from the wire spacing and wire ...',
        },
    )
    screen_beam_diffuse_solar_transmittance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    screen_beam_diffuse_solar_reflectance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    screen_beam_beam_visible_transmittance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    screen_beam_diffuse_visible_transmittance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    screen_beam_diffuse_visible_reflectance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    screen_infrared_transmittance: float | None = Field(
        default=0.02,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    screen_infrared_emissivity: float | None = Field(
        default=0.93,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    screen_wire_spacing: float | None = Field(
        default=0.025,
        gt=0.0,
        json_schema_extra={
            'units': 'm',
    ...
    screen_wire_diameter: float | None = Field(
        default=0.005,
        gt=0.0,
        json_schema_extra={
            'units': 'm',
...
class WindowMaterialShade(IDFBaseModel):
    ...
    infrared_hemispherical_emissivity: float = Field(
        ..., gt=0.0, lt=1.0, json_schema_extra={'units': 'dimensionless'}
    )
    infrared_transmittance: float = Field(
        ..., ge=0.0, lt=1.0, json_schema_extra={'units': 'dimensionless'}
    )
    thickness: float = Field(..., gt=0.0, json_schema_extra={'units': 'm'})
    conductivity: float = Field(..., gt=0.0, json_schema_extra={'units': 'W/m-K'})
    shade_to_glass_distance: float | None = Field(
        default=0.05, ge=0.001, le=1.0, json_schema_extra={'units': 'm'}
    )
    ...
    airflow_permeability: float | None = Field(
        default=0.0, ge=0.0, le=0.8, json_schema_extra={'units': 'dimensionless'}
    )
...
class WindowMaterialShadeEquivalentLayer(IDFBaseModel):
    ...
    _provider_fields: ClassVar[frozenset[str]] = frozenset({'name'})
    name: str = Field(...)
    shade_beam_beam_solar_transmittance: float | None = Field(
        default=0.0,
        ge=0.0,
        le=0.8,
        json_schema_extra={
    ...
    front_side_shade_beam_diffuse_solar_transmittance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_shade_beam_diffuse_solar_transmittance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    front_side_shade_beam_diffuse_solar_reflectance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_shade_beam_diffuse_solar_reflectance: float = Field(
        ...,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    shade_beam_beam_visible_transmittance_at_normal_incidence: float | None = Field(
        default=None,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    shade_beam_diffuse_visible_transmittance_at_normal_incidence: float | None = Field(
        default=None,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    shade_beam_diffuse_visible_reflectance_at_normal_incidence: float | None = Field(
        default=None,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    shade_material_infrared_transmittance: float | None = Field(
        default=0.05,
        ge=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    front_side_shade_material_infrared_emissivity: float | None = Field(
        default=0.91,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
    ...
    back_side_shade_material_infrared_emissivity: float | None = Field(
        default=0.91,
        gt=0.0,
        lt=1.0,
        json_schema_extra={
...
class WindowMaterialSimpleGlazingSystem(IDFBaseModel):
    ...
    u_factor: float = Field(
        ...
        json_schema_extra={
            'units': 'W/m2-K',
            'note': 'Enter U-Factor including film coefficients',
        },
    )
    solar_heat_gain_coefficient: float = Field(
        ..., gt=0.0, lt=1.0, json_schema_extra={'note': 'SHGC at Normal Incidence'}
    )
    visible_transmittance: float | None = Field(
        default=None,
        gt=0.0,
        lt=1.0,
        json_schema_extra={'note': 'VT at Normal Incidence optional'},
    )
...
class WindowThermalModelParams(IDFBaseModel):
    ...
    _provider_fields: ClassVar[frozenset[str]] = frozenset({'name'})
    name: str = Field(...)
    standard: Literal['', 'EN673Declared', 'EN673Design', 'ISO15099'] | None = Field(
        default='ISO15099'
    )
    thermal_model: (
        Literal[
        ...
        | None
    ) = Field(default='ISO15099')
    sdscalar: float | None = Field(default=1.0, ge=0.0, le=1.0)
    deflection_model: (
        Literal['', 'MeasuredDeflection', 'NoDeflection', 'TemperatureAndPressureInput']
        | None
    ) = Field(default='NoDeflection')
    vacuum_pressure_limit: float | None = Field(
        default=13.238, gt=0.0, json_schema_extra={'units': 'Pa'}
    )
    initial_temperature: float | None = Field(
        default=25.0,
        gt=0.0,
...
class WindowsCalculationEngine(IDFBaseModel):
    ...
    windows_engine: (
        Literal['', 'BuiltInWindowsModel', 'ExternalWindowsModel'] | None
    ) = Field(default='BuiltInWindowsModel')
