...
C10*x*y**2"""
    ...
    minimum_curve_output: float | None = Field(default=None, json_schema_extra={'note': 'Specify the minimum value calculated by this curve object'})
    maximum_curve_output: float | None = Field(default=None, json_schema_extra={'note': 'Specify the maximum value calculated by this curve object'})
    input_unit_type_for_x: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Temperature', 'VolumetricFlow'] | None = Field(default='Dimensionless')
    input_unit_type_for_y: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Temperature', 'VolumetricFlow'] | None = Field(default='Dimensionless')
...
Chilled Water Temperature - Reference Chilled Water Temperature"""
    ...
    minimum_curve_output: float | None = Field(default=None, json_schema_extra={'note': 'Specify the minimum value calculated by this curve object'})
    maximum_curve_output: float | None = Field(default=None, json_schema_extra={'note': 'Specify the maximum value calculated by this curve object'})
    input_unit_type_for_x: Literal['', 'Dimensionless'] | None = Field(default='Dimensionless')
    input_unit_type_for_y: Literal['', 'Dimensionless'] | None = Field(default='Dimensionless')
    input_unit_type_for_z: Literal['', 'Dimensionless'] | None = Field(default='Dimensionless')
    output_unit_type: Literal['', 'Capacity', 'Dimensionless', 'Power', 'Pressure', 'Temperature'] | None = Field(default='Dimensionless')
...
C3*x**2 + C4*x**3) + (C5 + C6*x)*y"""
    ...
    minimum_curve_output: float | None = Field(default=None, json_schema_extra={'note': 'Specify the minimum value calculated by this curve object'})
    maximum_curve_output: float | None = Field(default=None, json_schema_extra={'note': 'Specify the maximum value calculated by this curve object'})
    input_unit_type_for_x: Literal['', 'Dimensionless', 'Temperature'] | None = Field(default='Dimensionless')
    input_unit_type_for_y: Literal['', 'Dimensionless', 'Temperature'] | None = Field(default='Dimensionless')
    output_unit_type: Literal['', 'Capacity', 'Dimensionless', 'Power', 'Pressure', 'Temperature'] | None = Field(default='Dimensionless')
...
by C2, and C1 is added to the result."""
    ...
    minimum_value_of_x: float = Field(..., json_schema_extra={'note': 'Specify the minimum value of the independent variable x allowed'})
    maximum_value_of_x: float = Field(..., json_schema_extra={'note': 'Specify the maximum value of the independent variable x allowed'})
    minimum_curve_output: float | None = Field(default=None, json_schema_extra={'note': 'Specify the minimum value calculated by this curve object'})
    maximum_curve_output: float | None = Field(default=None, json_schema_extra={'note': 'Specify the maximum value calculated by this curve object'})
    input_unit_type_for_x: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Temperature', 'VolumetricFlow'] | None = Field(default='Dimensionless')
    output_unit_type: Literal['', 'Capacity', 'Dimensionless', 'Power', 'Pressure', 'Temperature'] | None = Field(default='Dimensionless')
...
curve. curve = see Input Output Reference"""
    ...
    name: str = Field(..., json_schema_extra={'note': 'See InputOut Reference for curve description'})
    coefficient1_c1: float = Field(...)
    coefficient2_c2: float = Field(...)
    coefficient3_c3: float = Field(...)
    coefficient4_c4: float = Field(...)
...
Po) Po assumed to be zero See InputOut Reference for curve details"""
    ...
    minimum_curve_output: float | None = Field(default=None, json_schema_extra={'units': 'Pa', 'note': 'Specify the minimum value calculated by this curve object'})
    maximum_curve_output: float | None = Field(default=None, json_schema_extra={'units': 'Pa', 'note': 'Specify the maximum value calculated by this curve object'})
...
/ 2"""
    ...
    name: str = Field(...)
    diameter: float = Field(..., gt=0.0, json_schema_extra={'units': 'm', 'note': '"D" in above expression, used to also calculate local velocity'})
    minor_loss_coefficient: float | None = Field(default=None, gt=0.0, json_schema_extra={'units': 'dimensionless', 'note': '"K" in above expression'})
    length: float | None = Field(default=None, gt=0.0, json_schema_extra={'units': 'm', 'note': '"L" in above expression'})
    roughness: float | None = Field(default=None, gt=0.0, json_schema_extra={'units': 'm', 'note': 'This will be used to calculate "f" from Moody-chart approximations'})
    fixed_friction_factor: float | None = Field(default=None, gt=0.0, json_schema_extra={'note': 'Optional way to set a constant value for "f", instead of using internal Moody-chart approximations'})
...
+ C2*x"""
    ...
    minimum_curve_output: float | None = Field(default=None, json_schema_extra={'note': 'Specify the minimum value calculated by this curve object'})
    maximum_curve_output: float | None = Field(default=None, json_schema_extra={'note': 'Specify the maximum value calculated by this curve object'})
    input_unit_type_for_x: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Pressure', 'Temperature', 'VolumetricFlow'] | None = Field(default='Dimensionless')
    output_unit_type: Literal['', 'Capacity', 'Dimensionless', 'Power', 'Pressure', 'Temperature'] | None = Field(default='Dimensionless')
...
+ C2*w + C3*x + C4*y + C5*z"""
    ...
    minimum_curve_output: float | None = Field(default=None, json_schema_extra={'note': 'Specify the minimum value calculated by this curve object'})
    maximum_curve_output: float | None = Field(default=None, json_schema_extra={'note': 'Specify the maximum value calculated by this curve object'})
    input_unit_type_for_w: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Temperature', 'VolumetricFlow', 'VolumetricFlowPerPower'] | None = Field(default='Dimensionless')
    input_unit_type_for_x: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Temperature', 'VolumetricFlow', 'VolumetricFlowPerPower'] | None = Field(default='Dimensionless')
    input_unit_type_for_y: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Temperature', 'VolumetricFlow', 'VolumetricFlowPerPower'] | None = Field(default='Dimensionless')
    input_unit_type_for_z: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Temperature', 'VolumetricFlow', 'VolumetricFlowPerPower'] | None = Field(default='Dimensionless')
...
+ C2*v + C3*w + C4*x + C5*y + C6*z"""
    ...
    minimum_curve_output: float | None = Field(default=None, json_schema_extra={'note': 'Specify the minimum value calculated by this curve object'})
    maximum_curve_output: float | None = Field(default=None, json_schema_extra={'note': 'Specify the maximum value calculated by this curve object'})
    input_unit_type_for_v: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Temperature', 'VolumetricFlow', 'VolumetricFlowPerPower'] | None = Field(default='Dimensionless')
    input_unit_type_for_w: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Temperature', 'VolumetricFlow', 'VolumetricFlowPerPower'] | None = Field(default='Dimensionless')
    input_unit_type_for_x: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Temperature', 'VolumetricFlow', 'VolumetricFlowPerPower'] | None = Field(default='Dimensionless')
    input_unit_type_for_y: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Temperature', 'VolumetricFlow', 'VolumetricFlowPerPower'] | None = Field(default='Dimensionless')
    input_unit_type_for_z: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Temperature', 'VolumetricFlow', 'VolumetricFlowPerPower'] | None = Field(default='Dimensionless')
...
a24*x*y**2*z + a25*x*y*z**2 +a26*x*y*z"""
    ...
    input_unit_type_for_x: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Temperature', 'VolumetricFlow'] | None = Field(default='Dimensionless')
    input_unit_type_for_y: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Temperature', 'VolumetricFlow'] | None = Field(default='Dimensionless')
    input_unit_type_for_z: Literal['', 'Dimensionless', 'Distance', 'MassFlow', 'Power', 'Temperature', 'VolumetricFlow'] | None = Field(default='Dimensionless')
    output_unit_type: Literal['', 'Capacity', 'Dimensionless', 'Power', 'Pressure', 'Temperature'] | None = Field(default='Dimensionless')
