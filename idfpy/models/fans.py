...
drive (if used)."""
    ...
    @property
    def normalized_fan_static_efficiency_curve_name_non_stall_region_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def normalized_fan_static_efficiency_curve_name_stall_region_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def normalized_dimensionless_airflow_curve_name_non_stall_region_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def normalized_dimensionless_airflow_curve_name_stall_region_ref(self) -> IDFBaseModel | None:
