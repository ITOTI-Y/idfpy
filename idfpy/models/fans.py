...
drive (if used)."""
    ...
    @property
    def normalized_fan_static_efficiency_curve_non_stall_region_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def normalized_fan_static_efficiency_curve_stall_region_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def normalized_dimensionless_airflow_curve_non_stall_region_ref(self) -> IDFBaseModel | None:
    ...
    @property
    def normalized_dimensionless_airflow_curve_stall_region_ref(self) -> IDFBaseModel | None:
