...
class ZoneHVACEquipmentListEquipmentItem(IDFBaseModel):
    ...
    @property
    def zone_equipment_sequential_cooling_fraction_schedule(self) -> IDFBaseModel | None:
    ...
    @property
    def zone_equipment_sequential_heating_fraction_schedule(self) -> IDFBaseModel | None:
...
Simulation\" is Yes."""
    ...
    @property
    def space_return_air_node_1_flow_rate_fraction_schedule(self) -> IDFBaseModel | None:
...
for Simulation\" is Yes."""
    ...
    name: str = Field(...)
    zone_name: ZoneNamesRef = Field(..., json_schema_extra={'object_list': ['ZoneNames'], 'note': 'Must be a controlled zone which has a ZoneHVAC:EquipmentConnections object.'})
