...
class Branch(IDFBaseModel):
    ...
    pressure_drop_curve_name: UnivariateFunctionsRef | None = Field(
        ...
        json_schema_extra={
            ...
            'note': 'Optional field to include this branch in plant pressure drop calculations This field is only relevant for branches in PlantLoops and CondenserLoops Air loops do not account for pressure drop using ...',
        },
    )
...
class PipingSystemUndergroundDomain(IDFBaseModel):
    ...
    x_direction_mesh_density_parameter: int | None = Field(
        default=4,
        gt=0,
        json_schema_extra={
    ...
    x_direction_geometric_coefficient: float | None = Field(
        default=1.3,
        ge=1.0,
        le=2.0,
        json_schema_extra={
    ...
    y_direction_mesh_density_parameter: int | None = Field(
        default=4,
        gt=0,
        json_schema_extra={
            'note': 'If mesh type is symmetric geometric, this should be an even number.'
    ...
    y_direction_geometric_coefficient: float | None = Field(
        default=1.3,
        ge=1.0,
        le=2.0,
        json_schema_extra={
    ...
    z_direction_mesh_density_parameter: int | None = Field(
        default=4,
        gt=0,
        json_schema_extra={
            'note': 'If mesh type is symmetric geometric, this should be an even number.'
    ...
    z_direction_geometric_coefficient: float | None = Field(
        default=1.3,
        ge=1.0,
        le=2.0,
        json_schema_extra={
    ...
    width_of_basement_floor_in_ground_domain: float | None = Field(
        default=None,
        json_schema_extra={
            'units': 'm',
    ...
    depth_of_basement_wall_in_ground_domain: float | None = Field(
        default=None,
        json_schema_extra={
            'units': 'm',
            'note': 'Required only if Domain Has Basement Interaction',
    ...
    shift_pipe_x_coordinates_by_basement_width: Literal['No', 'Yes'] | None = Field(
        default=None,
    ...
    convergence_criterion_for_the_outer_cartesian_domain_iteration_loop: (
        float | None
    ) = Field(default=0.001, ge=1e-06, le=0.5, json_schema_extra={'units': 'deltaC'})
    maximum_iterations_in_the_outer_cartesian_domain_iteration_loop: int | None = Field(
        default=500, ge=3, le=10000
    )
...
class PipingSystemUndergroundPipeCircuit(IDFBaseModel):
    ...
    pipe_specific_heat: float = Field(
    ...
    convergence_criterion_for_the_inner_radial_iteration_loop: float | None = Field(
        default=0.001, ge=1e-06, le=0.5, json_schema_extra={'units': 'deltaC'}
    )
    maximum_iterations_in_the_inner_radial_iteration_loop: int | None = Field(
        default=500, ge=3, le=10000
    )
    number_of_soil_nodes_in_the_inner_radial_near_pipe_mesh_region: int | None = Field(
        default=3, ge=1, le=15
    )
    radial_thickness_of_inner_radial_near_pipe_mesh_region: float = Field(
        ...,
        gt=0.0,
        json_schema_extra={
    ...
    pipe_segments: list[PipingSystemUndergroundPipeCircuitPipeSegmentsItem] | None = (
        Field(default=None)
    )
...
class PipingSystemUndergroundPipeSegment(IDFBaseModel):
    ...
    x_position: float = Field(
        ...
        json_schema_extra={
            'units': 'm',
            'note': 'This segment will be centered at this distance from the x=0 domain surface or the basement wall surface, based on whether a basement exists in this domain and the selection of the shift input field...',
        },
    )
    ...
    flow_direction: Literal['DecreasingZ', 'IncreasingZ'] = Field(
        ...,
        json_schema_extra={
