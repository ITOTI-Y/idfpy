...
if TYPE_CHECKING:
    from .location import SiteGroundTemperatureUndisturbedFiniteDifference, SiteGroundTemperatureUndisturbedKusudaAchenbach, SiteGroundTemperatureUndisturbedXing
...
class PipingSystemUndergroundDomain(IDFBaseModel):
    ...
    @property
    def name_of_basement_wall_boundary_condition_model_ref(self) -> SurfacePropertyOtherSideConditionsModel | None:
    ...
    @property
    def name_of_basement_floor_boundary_condition_model_ref(self) -> SurfacePropertyOtherSideConditionsModel | None:
