...
class AirLoopHVACDedicatedOutdoorAirSystemAirloophvacsItem(IDFBaseModel):
    ...
    airloophvac_name: AirPrimaryLoopsRef | None = Field(default=None, json_schema_extra={'object_list': ['AirPrimaryLoops'], 'note': 'The rest of fields are extensible. It requires AirLoopHVAC names served by an AirLoopHVAC:DedicatedOutdoorAirSystem.'})
...
class AirLoopHVACReturnPathComponentsItem(IDFBaseModel):
    """Nested object type for array items."""
    component_object_type: Literal['AirLoopHVAC:ReturnPlenum', 'AirLoopHVAC:ZoneMixer'] = Field(...)
    component_name: ReturnPathComponentNamesRef = Field(..., json_schema_extra={'object_list': ['ReturnPathComponentNames']})
...
class AirLoopHVACSupplyPathComponentsItem(IDFBaseModel):
    """Nested object type for array items."""
    component_object_type: Literal['AirLoopHVAC:SupplyPlenum', 'AirLoopHVAC:ZoneSplitter'] = Field(..., json_schema_extra={'note': 'Supply path components must be listed in flow order.'})
    component_name: SupplyPathComponentNamesRef = Field(..., json_schema_extra={'object_list': ['SupplyPathComponentNames']})
...
class AirLoopHVAC(IDFBaseModel):
    ...
    name: str = Field(...)
    controller_list_name: ControllerListsRef | None = Field(default=None, json_schema_extra={'object_list': ['ControllerLists'], 'note': 'Enter the name of an AirLoopHVAC:ControllerList object.'})
    ...
    design_supply_air_flow_rate: float | Literal['', 'Autosize'] | None = Field(default=0.0, json_schema_extra={'units': 'm3/s'})
    branch_list_name: BranchListsRef = Field(..., json_schema_extra={'object_list': ['BranchLists'], 'note': 'Name of a BranchList containing all the branches in this air loop'})
    connector_list_name: ConnectorListsRef | None = Field(default=None, json_schema_extra={'object_list': ['ConnectorLists'], 'note': 'Name of a ConnectorList containing all the splitters and mixers in the loop'})
    supply_side_inlet_node_name: str = Field(..., json_schema_extra={'note': 'Name of inlet node where air enters the supply side of the air loop. If this air loop has a return path, then this node is where return air enters the supply side. If this air loop has no return pa...'})
    demand_side_outlet_node_name: str | None = Field(default=None, json_schema_extra={'note': 'Name of outlet node where return air leaves the demand side and enters the supply side. Required if this air loop has a return path. Leave this field blank if there is no return.'})
    demand_side_inlet_node_names: str = Field(..., json_schema_extra={'note': 'Name of a Node or NodeList containing the inlet node(s) supplying air to zone equipment.'})
    supply_side_outlet_node_names: str = Field(..., json_schema_extra={'note': 'Name of a Node or NodeList containing the outlet node(s) supplying air to the demand side.'})
    design_return_air_flow_fraction_of_supply_air_flow: float | None = Field(default=1.0, ge=0.0, json_schema_extra={'note': 'The design return air flow rate as a fraction of supply air flow rate with no exhaust. This can be used to model a pressurized system or set to zero to model a DOAS with no return flow. Use ZoneAir...'})
...
multiple AirLoopHVACs."""
    ...
    _provider_fields: ClassVar[frozenset[str]] = frozenset({"name"})
    name: str = Field(...)
    airloophvac_outdoorairsystem_name: ValidBranchEquipmentNamesRef | None = Field(default=None, json_schema_extra={'object_list': ['validBranchEquipmentNames'], 'note': 'Enter the name of an AirLoopHVAC:OutdoorAirSystem object.'})
    ...
    airloophvac_mixer_name: AirLoopHVACMixerNamesRef = Field(..., json_schema_extra={'object_list': ['AirLoopHVACMixerNames'], 'note': 'Name of AirLoopHVAC:Mixer.'})
    airloophvac_splitter_name: AirLoopHVACSplitterNamesRef = Field(..., json_schema_extra={'object_list': ['AirLoopHVACSplitterNames'], 'note': 'Name of AirLoopHVAC:Splitter.'})
    ...
    number_of_airloophvac: int = Field(..., json_schema_extra={'note': 'Enter the number of the AirLoopHVAC served by AirLoopHVAC:DedicatedOutdoorAirSystem'})
    airloophvacs: list[AirLoopHVACDedicatedOutdoorAirSystemAirloophvacsItem] | None = Field(default=None)
...
or more ZoneHVAC:ExhaustControl outlet nodes via an AirLoopHVAC:ZoneMixer."""
    ...
    zone_mixer_name: ZoneMixersRef = Field(..., json_schema_extra={'object_list': ['ZoneMixers'], 'note': 'The name of the exhaust system AirLoopHVAC:ZoneMixer'})
    fan_object_type: Literal['Fan:ComponentModel', 'Fan:SystemModel'] = Field(...)
    fan_name: FansComponentModelRef | FansSystemModelRef = Field(..., json_schema_extra={'object_list': ['FansComponentModel', 'FansSystemModel']})
...
outdoor air system is treated as a single component."""
    ...
    _provider_fields: ClassVar[frozenset[str]] = frozenset({"name"})
    name: str = Field(...)
    controller_list_name: ControllerListsRef | None = Field(default=None, json_schema_extra={'object_list': ['ControllerLists'], 'note': 'Enter the name of an AirLoopHVAC:ControllerList object or blank if this object is used in AirLoopHVAC:DedicatedOutdoorAirSystem.'})
    outdoor_air_equipment_list_name: AirLoopOAEquipmentListsRef = Field(..., json_schema_extra={'object_list': ['AirLoopOAEquipmentLists'], 'note': 'Enter the name of an AirLoopHVAC:OutdoorAirSystem:EquipmentList object.'})
    ...
    @property
    def outdoor_air_equipment_list(self) -> AirLoopHVACOutdoorAirSystemEquipmentList | None:
...
class AirLoopHVACOutdoorAirSystemEquipmentList(IDFBaseModel):
    ...
    _provider_fields: ClassVar[frozenset[str]] = frozenset({"name"})
    name: str = Field(...)
    component_1_object_type: ValidOASysEquipmentTypesRef = Field(..., json_schema_extra={'object_list': ['validOASysEquipmentTypes']})
    component_1_name: ValidOASysEquipmentNamesRef = Field(..., json_schema_extra={'object_list': ['validOASysEquipmentNames']})
    component_2_object_type: ValidOASysEquipmentTypesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentTypes']})
    component_2_name: ValidOASysEquipmentNamesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentNames']})
    component_3_object_type: ValidOASysEquipmentTypesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentTypes']})
    component_3_name: ValidOASysEquipmentNamesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentNames']})
    component_4_object_type: ValidOASysEquipmentTypesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentTypes']})
    component_4_name: ValidOASysEquipmentNamesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentNames']})
    component_5_object_type: ValidOASysEquipmentTypesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentTypes']})
    component_5_name: ValidOASysEquipmentNamesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentNames']})
    component_6_object_type: ValidOASysEquipmentTypesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentTypes']})
    component_6_name: ValidOASysEquipmentNamesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentNames']})
    component_7_object_type: ValidOASysEquipmentTypesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentTypes']})
    component_7_name: ValidOASysEquipmentNamesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentNames']})
    component_8_object_type: ValidOASysEquipmentTypesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentTypes']})
    component_8_name: ValidOASysEquipmentNamesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentNames']})
    component_9_object_type: ValidOASysEquipmentTypesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentTypes']})
    component_9_name: ValidOASysEquipmentNamesRef | None = Field(default=None, json_schema_extra={'object_list': ['validOASysEquipmentNames']})
...
OutdoorAir:Mixer object or across all outdoor air mixers."""
    ...
    _provider_fields: ClassVar[frozenset[str]] = frozenset({"name"})
    name: str = Field(...)
    mixed_air_node_name: str = Field(..., json_schema_extra={'note': 'Name of Mixed Air Node'})
    outdoor_air_stream_node_name: str = Field(..., json_schema_extra={'note': 'Name of Outdoor Air Stream Node'})
    relief_air_stream_node_name: str = Field(..., json_schema_extra={'note': 'Name of Relief Air Stream Node'})
